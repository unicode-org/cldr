...
| superessive  | The superessive case expresses that the referent of the noun it marks is the location on which another referent exists. It has the meaning of 'on' or 'upon'. | http://purl.org/olia/olia.owl#SuperessiveCase linguistics-ontology.org/gold/2010/SuperessiveCase |
| terminative  | The terminative case expresses the motion of something into but not further than (ie, not through) the referent of the noun it marks. It has the meaning 'into but not through'.  | http://purl.org/olia/olia.owl#TerminativeCase linguistics-ontology.org/gold/2010/TerminativeCasehttp:// |
