...
* General
  * Fixed links into cldr.unicode.org and the maintenance branch. — [CLDR-15131](https://unicode-org.atlassian.net/browse/CLDR-15131)
* Locales
  * Revised language on locale coverage levels, pointed to separate web page describing the requirements at each level. [§8 Coverage Levels](tr35-info.md#Coverage_Levels) — [CLDR-15378](https://unicode-org.atlassian.net/browse/CLDR-15378)
  * Documented lookup chain for multiple variants. [§4 Locale Inheritance and Matching](#Locale_Inheritance) — [CLDR-15115](https://unicode-org.atlassian.net/browse/CLDR-15115)
  * Documented the new linebreak "lw" value of "phrase", used for Japanese. [§3.6.1 Key And Type Definitions](#UnicodeLineBreakWordIdentifier) — [CLDR-15448](https://unicode-org.atlassian.net/browse/CLDR-15448)
...
* Dates
  ...
  * Clarified dateTimeItem pattern adjustments. [§2.6.2.1 Matching Skeletons](tr35-dates.md#Matching_Skeletons) — [CLDR-14108](https://unicode-org.atlassian.net/browse/CLDR-14108)
  ...
  * Documented the relationship between TZDB links and CLDR's BCP47 timzone aliases. [§3.6.3 Time Zone Identifiers](tr35.md#Time_Zone_Identifiers) — [CLDR-14927](https://unicode-org.atlassian.net/browse/CLDR-14927)
