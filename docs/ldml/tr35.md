...
4. Declare when it overrides CLDR, or uses `alt` data
...
The following are the main sections that implementations claim conformance to. This is not exhaustive: 

#### Unicode Locale Identifiers
| Operation / Structure | Sections |
| --- | --- |
| locale identifiers, well-formedness, validity  | [Unicode Locale Identifier](#Unicode_locale_identifier)|
...
| Operation / Structure | Sections |
| --- | --- |
| Unicode Set notation | [Unicode Sets](#Unicode_Sets) |
| String range notation | [String Range](#string-range) |
| Transforms / Transliteration | [Transforms](tr35-general.html#Transforms)

#### Units of Measurement
| Operation / Structure | Sections |
| --- | --- |
| unit identifiers, well-formedness, validity | [Unit Identifiers](tr35-general.html#unit-identifiers) |
