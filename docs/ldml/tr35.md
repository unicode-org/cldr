...
|Corrigenda| https://cldr.unicode.org/corrigenda |
...
_See also [Unicode Extensions for BCP 47](https://cldr.unicode.org/bcp47-extension) on the CLDR site._
...
The attribute `draft="x"` in LDML means that the data has not been approved by the subcommittee. (For more information, see [Process](https://cldr.unicode.org/process)). However, some data that is not explicitly marked as `draft` may be implicitly `draft`, either because it inherits it from a parent, or from an enclosing element.
...
For more information on precisely how these values are computed for any given release, see [Data Submission and Vetting Process](https://cldr.unicode.org/process#h.krygv7y7jkk9) on the CLDR website.
...
Where an the implementation only includes (say) the CLDR locales at Basic coverage in [Unicode CLDR - Coverage Levels](https://cldr.unicode.org/cldr-spec/coverage-levels)
...
| -------------------------------------------------------- | --- |
| [<a name="Bugs" href="#Bugs">Bugs</a>]                   | CLDR Bug Reporting form<br/>[https://cldr.unicode.org/bug-reports](https://cldr.unicode.org/bug-reports) |
...
| [<a name="ByType" href="#ByType">ByType</a>]             | CLDR Comparison Charts<br/>[https://cldr.unicode.org/charts](https://cldr.unicode.org/charts) |
