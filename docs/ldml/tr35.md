...
* \$ is equivalent to \uFFFF when appearing at the very end of a set with or without trailing whitespace (**[a-z\$]**, **[a-z\$ ]**), and used as starting indicator for a variable reference elsewhere, where the variable name will be the longest match on the `var` nonterminal (**[\$my_set]**).
