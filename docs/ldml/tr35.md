...
The **Equivalent** values in the Subset variants are only approximate.

Visual variant script codes can be used in a locale identifier to request a particular rendering.
