...
* **Locales**
  ...
  * Improved the specification information about the effect of locale keywords
    * "fw" keyword in [Week Data](tr35-dates.md#Week_Data)
    * "hc" keyword [Time Data](tr35-dates.md#Time_Data)
    * "dx", "lb", "lw", "ss" keywords [Segmentations][tr35-general.md#segmentations]
    * "cf" keyword [Segmentations][tr35-numbers.md#Currency_Formats]
    * "ca", "cf", "dx", "fw", "hc", "lb", "lw", "ms", "mu", "rg" keywords [Key And Type Definitions](#Key_And_Type_Definitions_)
  * [Parent Locales](#Parent_Locales)
    * Documented the new `component` attribute, including the behavior changes in inheritance for different components
  * [Region-Priority Inheritance](#Region_Priority_Inheritance)
    * Documented the differences in inheritance for rgScope data, which inherits primarily by region. 
	* Includes small changes in [`<rgScope>`: Scope of the “rg” Locale Key](tr35-info.md#rgScope), [Lookup](#lookup), and [Bundle vs Item Lookup](#Bundle_vs_Item_Lookup)
* [Data Size Reduction](#Data_Size)
  * Added new section with guidance on reducing CLDR data size where necessary.
