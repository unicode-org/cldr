...
The `standard` and `search` types are general — other [`ufield`](https://unicode.org/reports/tr35/#ufield)s provide additional choices for certain locales; *they only have effect in certain locales.*
