...
1. Identify the sections of the specification that it conforms to.
   ...
   * Such sections can be identified by links, which remain stable.
Sometimes the names of sections may change somewhat, but the underlying links remain stable.
...
The following lists sections structures and/or processing algorithms, and the relevant sections. Conformance to a particular section may reference and require conformance to another section.

#### Unicode Locale Identifiers
| Structure / Processing | Sections |
| --- | --- |
| identifier syntax, interpretation, and validity | [Unicode Locale Identifier](#Unicode_locale_identifier)|
| canonicalize | [Canonical Unicode Locale Identifiers](#Canonical_Unicode_Locale_Identifiers), references [Annex C. LocaleId Canonicalization](#LocaleId_Canonicalization) |
| convert | [CLDR to BCP 47](#Unicode_Locale_Identifier_CLDR_to_BCP_47), [BCP 47 to CLDR](#Unicode_Locale_Identifier_BCP_47_to_CLDR) |
| interpret | [Language Identifier Field Definitions](#Field_Definitions) |
| locale display names | [Locale Display Name Algorithm](https://www.unicode.org/reports/tr35/tr35-72/tr35-general.html#locale_display_name_algorithm) |

#### Unicode Locale Inheritance and Matching
| Structure / Processing | Sections |
| --- | --- |
| locale inheritance  | [Locale Inheritance and Matching](#Locale_Inheritance), references [Default Content](tr35-info.html#Default_Content), [Parent Locales](#Parent_Locales) |
| likely subtags | [Likely Subtags](#Likely_Subtags) |
| locale matching | [Language Matching](#LanguageMatching) |

#### General Structure
| Structure / Processing | Sections |
| --- | --- |
| Unicode set syntax and interpretation | [Unicode Sets](#Unicode_Sets) |
| string-range syntax and interpretation | [String Range](#string-range) |
| transform syntax and interpretation | [Transforms](tr35-general.html#Transforms)

#### Units of Measurement
| Structure / Processing | Sections |
| --- | --- |
| unit identifier syntax, interpretation, and validity | [Unit Identifiers](tr35-general.html#unit-identifiers) |
| unit display names | [Compound Units](tr35-general.html#compound-units) |
...
or use a [private use extension](#pu_extensions) in a Unicode locale identifer. 
...
* Part 6: [Supplemental](tr35-info.md#Contents)
  ...
  * In [Unit Prefixes](tr35-info.md#unit-prefixes), added the SI unit prefixes and the power of 10
