...
| - | - |
| **\[^a\]** | the set of all Unicode code points except 'a'. |
| **\[ ^a\]** | *a syntax error.* |
| **\[a^\]** | *a syntax error.* |
| **\[\^a\]** | the set of 'a' and '^'. |
| **\[:\]** | *a syntax error.* |
...
| **\[L:\]** | the set of 'L' and ':'. |
| **\[:L\]** | *a syntax error.* |
| **\[:L:\]** | the set of all code points with Unicode property 'General_Category' equal to 'Letter'. |
|  **\[-\]** | the set of '-'. |
|  **\[  - \]** | the set of '-'. |
|  **\[a-\]** | the set of 'a' and '-'. |
|  **\[-b\]** | the set of 'b' and '-'. |
|  **\[a -b\]** | the set of all code points between 'a' and 'b' (inclusive). |
|  **\[[a-b] -[b]\]** | the set of 'a'. |
|  **\[^  - \]** | the set of all Unicode code points except '-'. |
|  **\[ ^  - \]** | *a syntax error.* |
|  **\[\$\]** | the set of U+FFFF. |
|  **\[ \$  \]** | the set of U+FFFF. |
|  **\[\$ a\]** | *a syntax error.* |
|  **\[\$a\]** | the set corresponding to the value of the variable '\$a', which could be either a full UnicodeSet, a string, or a char. |
|  **\[\$a\$\]** | the set of U+FFFF and the value of the variable '\$a', which could be either a full UnicodeSet, a string, or a char. |
|  **\[a\$\]** | the set of 'a' and U+FFFF. |
|  **\[\}\]** | the set of '\}'. |
|  **\[\{\}\]** | the set of the empty string, ''. |
|  **\[\{\]** | *a syntax error.* |
|  **\[\{\}\}\]** | the set of '\}' and the empty string. |
|  **\[\{\{\}\]** | the set of '\}'. |
|  **\[\{\$var\}\]** | the set of the string '\$var'. |
|  **\[\{\[a-z\}\]** | the set of the string '\[a-z'. |
|  **\[\{ \[ a - z\}\]**        | the set of the string '\[a-z'. |
|  **\[\\x\{10FFFF1\}\]**  | *a syntax error.* |
|  **\[\\x\{10FFFF 1\}\]** | the set of U+10FFFF and U+1'. |
