...
* Proposed Update for CLDR Version 41.

* General
  * Fix links into cldr.unicode.org and the maintenance branch. [CLDR-15131](https://unicode-org.atlassian.net/browse/CLDR-15131)
* Locales
  * Revise language on locale coverage levels, point to separate web page describing the requirements at each level. [CLDR-15378](https://unicode-org.atlassian.net/browse/CLDR-15378)
  * Document lookup chain for multiple variants [CLDR-15115](https://unicode-org.atlassian.net/browse/CLDR-15115)
  * Document the new linebreak "lw" value of "phrase", used for Japanese [CLDR-15448](https://unicode-org.atlassian.net/browse/CLDR-15448)
  * Document the use of hi-Latn for "Hinglish" (and similar cases), and clean up other text describing hybrid locales. [CLDR-15378](https://unicode-org.atlassian.net/browse/CLDR-15378)
  * Document the use of numeric and &alpha3 codes for CLDR region subtags. [CLDR-15420](https://unicode-org.atlassian.net/browse/CLDR-15420)
* List Patterns
  * Add invariants to list patterns to allow for simpler formatting algorithms [CLDR-15247](https://unicode-org.atlassian.net/browse/CLDR-15247)
* Numbers
  * Document how number ranges can be applied to more complex formats, including compact decimals, measurement units and currencies. [CLDR-14111](https://unicode-org.atlassian.net/browse/CLDR-14111) 
  * Clarify the discussion of how the plural rules work. [CLDR-15305](https://unicode-org.atlassian.net/browse/CLDR-15305) 
* Dates
  * In [Matching Skeletons](tr35-dates.md#Matching_Skeletons), miscellaneous clarifications to description of the pattern adjustment process. [CLDR-14108](https://unicode-org.atlassian.net/browse/CLDR-14108).
  * Clarify dateTimeItem pattern adjustments [CLDR-14108](https://unicode-org.atlassian.net/browse/CLDR-14108)
  * Fix example for <appendItems>  [CLDR-13185 ](https://unicode-org.atlassian.net/browse/CLDR-13185)
  * Document the relationship between TZDB links and CLDR's BCP47 timzone aliases. CLDR-14927](https://unicode-org.atlassian.net/browse/CLDR-14927)
* Deprecated Structure
  * Remove most of Annex A Deprecated Structure, referring to the DTD charts instead. [CLDR-15408](https://unicode-org.atlassian.net/browse/CLDR-15408)
