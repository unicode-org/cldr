...
NOTE: Some people may wonder why CLDR uses alphabetical order for variants, rather than the ordering in [Section 4.1](https://tools.ietf.org/search/bcp47#section-4.1) of BCP47. Here are the considerations that lead to that decision:
  ...
  * The best practices for internationalization have moved well beyond some of the guidelines and recommendations in BCP47, especially especially for language matching and language fallback.
  * Robust implementations will accept the variants in any order, just as they accept extensions in any order.
  * A canonical order allows for determination of identity of identifers via string comparison.
...
<tr><td colspan="4"><b>A <a name="UnicodeHourCycleIdentifier" id="UnicodeHourCycleIdentifier" href="#UnicodeHourCycleIdentifier">Unicode Hour Cycle Identifier</a> defines the preferred time cycle. Specifying "hc" in a locale identifier overrides the default value specified by supplemental time data (see Part 4 Dates, section 4.4 <a href="tr35-dates.html#Time_Data">Time Data</a>). The valid values are those <i>name</i> attribute values in the <i>type</i> elements of key name="hc" in bcp47/<a href="https://github.com/unicode-org/cldr/tree/latest/common/bcp47/calendar.xml" target="_blank">calendar.xml</a></b>.</td></tr>
...
<tr><td>en-t-<u>zh-h0-hybrid</u></td>   <td>Chinglish</td>   <td>American English with an admixture of Chinese (Mandarin, China)</td></tr>
<tr><td>en-t-<u>zh-Hant-h0-hybrid</u></td>   <td>Chinglish</td>   <td>American English with an admixture of Chinese (Mandarin, Taipai)</td></tr>
</tbody></table>
...
_Both the resource bundle inheritance and the inherited item inheritance use the parentLocale data, where available, instead of simple trunctation._
...
* General
  * Fix links into cldr.unicode.org and the maintenance branch. [CLDR-15131](https://unicode-org.atlassian.net/browse/CLDR-15131)
* Locales
  * Revise language on locale coverage levels, point to separate web page describing the requirements at each level. [§8 Coverage Levels](tr35-info.md#Coverage_Levels) [CLDR-15378](https://unicode-org.atlassian.net/browse/CLDR-15378)
  * Document lookup chain for multiple variants. [§4 Locale Inheritance and Matching](#Locale_Inheritance) [CLDR-15115](https://unicode-org.atlassian.net/browse/CLDR-15115)
  * Document the new linebreak "lw" value of "phrase", used for Japanese. [§3.6.1 Key And Type Definitions](#UnicodeLineBreakWordIdentifier) [CLDR-15448](https://unicode-org.atlassian.net/browse/CLDR-15448)
  * Document the use of hi-Latn for "Hinglish" (and similar cases), and clean up other text describing hybrid locales. [§3.10.2 Hybrid Locale Identifiers](#Hybrid_Locale) [CLDR-15378](https://unicode-org.atlassian.net/browse/CLDR-15378)
  * Document the use of numeric and &alpha3 codes for special CLDR region subtags. [§3.4 Language Identifier Field Definitions](#unicode_region_subtag_validity) [CLDR-15420](https://unicode-org.atlassian.net/browse/CLDR-15420)
* List Patterns
  * Add invariants to list patterns to allow for simpler formatting algorithms. [§11 List Patterns](tr35-general.md#ListPatterns) [CLDR-15247](https://unicode-org.atlassian.net/browse/CLDR-15247)
* Numbers
  ...
  * Clarify the discussion of how the plural rule syntax works. [§5.1 Plural rules syntax](tr35-numbers.md#Plural_rules_syntax) [CLDR-15305](https://unicode-org.atlassian.net/browse/CLDR-15305) 
* Dates
  * In [Matching Skeletons](tr35-dates.md#Matching_Skeletons) clarified the description of the pattern adjustment process. [§2.6.2.1 Matching Skeletons](tr35-dates.md#Matching_Skeletons) [CLDR-14108](https://unicode-org.atlassian.net/browse/CLDR-14108).
  * Clarify dateTimeItem pattern adjustments. [CLDR-14108](https://unicode-org.atlassian.net/browse/CLDR-14108)
  * Fix example for <appendItems>. [2.6 Element dateTimeFormats](tr35-dates.md#dateTimeFormats) [CLDR-13185 ](https://unicode-org.atlassian.net/browse/CLDR-13185)
  * Document the relationship between TZDB links and CLDR's BCP47 timzone aliases. [§3.6.3 Time Zone Identifiers](tr35.md#Time_Zone_Identifiers) [CLDR-14927](https://unicode-org.atlassian.net/browse/CLDR-14927)
* Deprecated Structure
  * Remove most of Annex A Deprecated Structure, referring to the DTD charts instead. [Annex A Deprecated Structure](#annex-a-deprecated-structure) [§CLDR-15408](https://unicode-org.atlassian.net/browse/CLDR-15408)
