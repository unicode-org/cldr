...
<tr><td>Date</td><td>2021-11-10</td></tr>
...
_However, if users typically expect a their language in non-default script to contain an admixture of another language, then the -t- and hybrid subtags may be omitted.
Thus if Hindi written in Latin script normally contains an admixture of English text, ‘hi-Latn’ can be used instead of ‘hi-Latn-t-en-h0-hybrid’._
...
<tr><td colspan="3">…</td></tr>
 ...
 _However, if users typically expect a their language in non-default script to contain an admixture of another language, then the -t- and hybrid subtags may be omitted. Thus if Hindi written in Latin script normally contains an admixture of English text, ‘hi-Latn’ can be used instead of ‘hi-Latn-t-en-h0-hybrid’._
...
Note that The default script for the language is computed without reference to the hybrid subtags. Thus the default script for Russian is “Cyrl”, no matter what the source is in the -t- tag.
...
* Proposed Update for CLDR Version 40.
...
* Locale Identifiers
  ...
  * Fixed ambiguity in the order of alias rules in [LocaleId Canonicalization](#LocaleId_Canonicalization) [CLDR-14629](https://unicode-org.atlassian.net/browse/CLDR-14629)
* Dates
...
* Units
  * In [Unit Elements](tr35-general.md#Unit_Elements), allowed for generative number prefixes, such as gallon-per-100-mile [CLDR-14751](https://unicode-org.atlassian.net/browse/CLDR-14751)
  * In [Unit Elements](tr35-general.md#Unit_Elements), added support for formatting currencies in units, such as curr-eur-per-square-meter [CLDR-14676](https://unicode-org.atlassian.net/browse/CLDR-14676)
  * Cleaned up the text and the EBNF in [Unit Identifiers](tr35-general.md#locale_display_name_algorithm) [CLDR-15035](https://unicode-org.atlassian.net/browse/CLDR-15035)
