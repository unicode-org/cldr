...
They can not make any Technical Decisions on their own.
...
The CLDR TC relies on the Design WG to recommend a design for any more complex changes since the CLDR TC no longer has enough overlapping membership with library projects,
...
The [CLDR MessageFormat WG][] was tasked with developing the specification for Message Format 2 (MF2) and ensuring implementations of MF2 in the ICU and ICU4X libraries. These recommendations, once approved, are incorporated into the CLDR data and tooling, and the LDML specification [Part 9: MessageFormat][].

The main page for the Message Format WG is in the [MessageFormat Repository][].

### CLDR Person Name Working Group

The [Person Name WG][] is responsible for the development of recommendations for person name formatting structure and data. These recommendations, once approved, are incorporated into the CLDR data and tooling, and the LDML specification [Part 8: Person Names][]. There is a development version at Part 8: Person Names (development).
...
[Part 8: Person Names]: https://www.unicode.org/reports/tr35/tr35-personNames.html
[Part 9: MessageFormat]: https://www.unicode.org/reports/tr35/tr35-messageFormat.html
