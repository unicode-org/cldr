...
|Asu|asa|
|Atsam|cch|
|Azeri (Arabic)|az_Arab|
|Azeri (Cyrillic)|az_Cyrl|
|Bafia|ksf|
|Bakhtiari|bqi|
|Baluchi|bal|
|Baluchi (Latin)|bal_Latn|
|Bambara|bm|
|Bambara (N’Ko)|bm_Nkoo|
|Basaa|bas|
|Bashkir|ba|
|Bemba|bem|
|Bena|bez|
...
|Dzongkha|dz|
|Embu|ebu|
|English (Deseret)|en_Dsrt|
|English (Shavian)|en_Shaw|
|Erzya|myv|
|Esperanto|eo|
|Ewondo|ewo|
|Friulian|fur|
...
|Interlingue|ie|
|Interslavic|isv|
|Interslavic (Cyrillic)|isv_Cyrl|
|Inuktitut|iu|
|Inuktitut (Latin)|iu_Latn|
|Jju|kaj|
|Jola-Fonyi|dyo|
|Kabyle|kab|
|Kako|kkj|
...
|Kangri|xnr|
|Kara-Kalpak|kaa|
|Kara-Kalpak (Latin)|kaa_Latn|
|Kazakh (Arabic)|kk_Arab|
|Kenyang|ken|
|Kikuyu|ki|
|Konkani (Latin)|kok_Latn|
|Koyra Chiini|khq|
|Koyraboro Senni|ses|
|Kpelle|kpe|
|Kurdish|ku|
|Kurdish (Arabic)|ku_Arab|
|Kuvi|kxv|
|Kuvi (Devanagari)|kxv_Deva|
|Kuvi (Odia)|kxv_Orya|
|Kuvi (Telugu)|kxv_Telu|
|Kwasio|nmg|
|Kʼicheʼ|quc|
|Ladin|lld|
|Lakota|lkt|
...
This list is created from [locale coverage chart](https://www.unicode.org/cldr/charts/dev/supplemental/locale_coverage.html) after removing locales maintained by the CLDR Technical Committee.
