...
- _Review all amendments that are dated after the previous update , and patch the XML files and the_ `supplementalData.xml` _as below._
- _Record the last number viewed in the URL above._
- _(There is a "download all amendments" link now that has a spreadsheet summary.)_
