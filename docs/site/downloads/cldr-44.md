...
Unicode CLDR provides key building blocks for software supporting the world's languages. CLDR data is used by all [major software systems](#h.ezpykkomyltl) (including all mobile phones) for their software internationalization and localization, adapting software to the conventions of different languages.
...
- The spec for \-u\-dx bcp47 subtag syntax requires further clarification. See [CLDR\-17194](https://unicode-org.atlassian.net/browse/CLDR-17194) . This is fixed in [version 44\.1](/downloads/cldr-44#h.nvqx283jwsx).
...
- unicodeVersion in ldmlSupplemental.dtd [was not updated to 15\.1 See CLDR\-17225](https://unicode-org.atlassian.net/browse/CLDR-17225). This is fixed in [version 44\.1](/downloads/cldr-44#h.nvqx283jwsx).
- Missing derived emoji annotations [CLDR\-17230](https://unicode-org.atlassian.net/browse/CLDR-17230).  This is fixed in [version 44\.1](/downloads/cldr-44#h.nvqx283jwsx).
- There was an error in the Keyboard3 DTD in the \<locale\> element. It is corrected in [version 44\.1](/downloads/cldr-44#h.nvqx283jwsx), see [CLDR\-17204](https://unicode-org.atlassian.net/browse/CLDR-17204)
- The keyboard charts were not able to generate properly due to DTD changes. It is corrected in [version 44\.1](/downloads/cldr-44#h.nvqx283jwsx). (This fixed code was used to generate the charts for version 44\.) [CLDR\-17205](https://unicode-org.atlassian.net/browse/CLDR-17205)
...
For web pages with different views of CLDR data, see <http://cldr.unicode.org/charts>.
