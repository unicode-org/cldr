...
* Added a [category of "New" in the Dashboard](https://cldr.unicode.org/translation/getting-started/vetting-view#dashboard-categories) and Vetting participation to make it easier for vetters to see which items did not have a winning value in the previous release and thus are "New" in the current release. 
