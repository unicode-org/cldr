...
-   [Previous](/downloads) - Previous available charts are linked from the download page in the Charts column
...
-   **Transform** - (Disabled temporarily) Some of the transforms in CLDR: the transliterations between different scripts. For more on transliterations, see [Transliteration Guidelines](/cldr-spec/transliteration-guidelines).
...
For more details on the locale data collection process, please see the [CLDR process](/process). For filing or viewing bug reports, see [CLDR Bug Reports](/requesting_changes).
