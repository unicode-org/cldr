...
These are supplied or generated from data supplied in [Core Data for New Locales](/cldr-spec/core-data-for-new-locales).
...
2.  ***plurals** — the number of different plural forms, and the rules for deriving them. See [Plural Rules](/cldr-spec/plural-rules)* and [Plurals & Units](/translation/getting-started/plurals)
3.  ***ordinals** — the number of different plural forms, and the rules for deriving them. See [Plural Rules](/cldr-spec/plural-rules)* and [Plurals & Units](/translation/getting-started/plurals)
