...
For further reference, see the [complete list](https://github.com/unicode-org/cldr/tree/main/common/bcp47/number.xml) of numbering system codes and their corresponding [rules](https://github.com/unicode-org/cldr/blob/main/common/supplemental/numberingSystems.xml).
