define({
	root: ({
		...
		v_oldvotes_winning_already_imported: "All of your votes that could be imported from all earlier versions, for items that match the last release (CLDR ${version}), have automatically been imported.",
		v_oldvotes_locale_msg: "Below are your previous votes that differed from the final value in the last release (CLDR ${version}) in ${locale}. You may choose to import them. However, please review each of the items first. If the current value in the last release (CLDR ${version}) is OK — even if it is not absolutely optimal — then for <a target='_blank' href='http://cldr.unicode.org/translation#TOC-Data-stability'>data stability</a> it is better not to import the vote. You can instead raise the issue in the forum and try to get consensus for change. Select or deselect items by clicking, and hit the button at the bottom to import votes.",
