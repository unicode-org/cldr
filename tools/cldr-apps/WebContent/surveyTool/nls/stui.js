define({
	root: ({
		...
		v_oldvotes_locale_msg: "These are your winning and losing votes for CLDR ${version} and earlier in ${locale}. Expand the section you want to work with, select or deselect items by clicking, and import votes.  By default, your old winning votes are selected for import, while your old losing votes are not.",
