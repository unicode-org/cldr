define({
	root: ({
		...
		v_oldvotes_desc_uncontested_msg: "These are your votes which agreed with the winning value in CLDR ${version} and earlier.",
		v_oldvotes_title_contested: "Losing Votes",
		v_oldvotes_desc_contested_msg: "These are your votes which did not agree with the winning value in CLDR ${version} and earlier. You may choose to import them if you believe they still represent the best value.",
		v_oldvotes_locale_list_help_msg: "Listed are locales which you have voted for in previous releases of CLDR. Click one to review and import your old votes. Note that some of the locales listed may have votes which are no longer valid in CLDR.",
		v_oldvotes_return_to_locale_list: "Return to List of Locales with old votes",
		v_oldvotes_path: "Path",
		v_oldvotes_locale_msg: "Below are your previous votes that differed from the final value in CLDR ${version} in ${locale}. You may choose to import them. However, please review each of the items first. If the current value in v${version} is OK — even if it is not absolutely optimal — then for <a target='_blank' href='http://cldr.unicode.org/translation#TOC-Data-stability'>data stability</a> it is better not to import the vote. You can instead raise the issue in the forum and try to get consensus for change. Expand the section you want to work with, select or deselect items by clicking, and hit the button at the bottom to import votes.",
