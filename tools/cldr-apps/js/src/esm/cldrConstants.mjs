export const SURVEY_TOOL_SESSION_HEADER = "X-SurveyTool-Session";
export const SLASH_API_SLASH = "/api/";
export const OAS3_ROOT = "/openapi"; // Path to the 'openapi' (sibling to cldr-apps). Needs to be a host-relative URL.
