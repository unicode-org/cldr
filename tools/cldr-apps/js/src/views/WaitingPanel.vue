<template>
    <div id="home">
        ...
        <ol>
            ...
            <li v-if="fetchErr" class="st-sad">I’m having some trouble contacting the SurveyTool.</li>
            <li v-if="statusData">Checking on SurveyTool status…</li>
            <li v-if="!statusData.triedToStartUp">SurveyTool hasn’t started yet.
            </li>
            <li v-if="!statusData.triedToStartUp && attemptedLoadErr">
                Still trying to get the SurveyTool to start.
            </li>
            <li v-if="!statusData.triedToStartUp && attemptedLoadCount && !attemptedLoadErr">
                Trying to start the SurveyTool…
            </li>
            <li v-if="statusData.triedToStartUp && !(statusData.status && statusData.status.isSetup)">The SurveyTool is trying to start.</li>
            <li v-if="statusData.triedToStartUp && (statusData.status && statusData.status.isSetup)">The SurveyTool started up.</li>
            <li v-if="statusData.status && statusData.status.isSetup" class="st-happy">Redirecting you to the SurveyTool!</li>
