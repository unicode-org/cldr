...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        /**
         * Obj is a typical class that implements JSONString. It also provides some beanie methods
         * that can be used to construct a JSONObject. It also demonstrates constructing a
         * JSONObject with an array of names.
         */
