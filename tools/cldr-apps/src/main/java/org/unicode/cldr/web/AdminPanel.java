...
public class AdminPanel {
  ...
  public void getJson(
    ...
    if (action == null || action.isEmpty()) {
      System.out.println(
        "Warning: AdminPanel.getJson called without do parameter!"
      );
      return;
    }
  ...
  private void unlinkUser(SurveyJSONWrapper r, HttpServletRequest request)
  ...
  private void setSettings(SurveyJSONWrapper r, HttpServletRequest request)
    throws JSONException {
