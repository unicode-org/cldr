  ...
  private static final Partition.Membership memberships[] = {
    ...
    new Partition.Membership("Date/Time Combination Formats") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|pattern\\|datetime-.*")
        );
      }
    },
    new Partition.Membership("Wide Month Names") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|month\\|.*-format-wide")
        );
      }
    },
    new Partition.Membership("Abbreviated Month Names") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|month\\|.*-format-abbreviated")
        );
      }
    },
    new Partition.Membership("Narrow Month Names") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|month\\|.*-stand-alone-narrow")
        );
      }
    },
    new Partition.Membership("Wide Month Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|month\\|.*-stand-alone-wide")
        );
      }
    },
    new Partition.Membership("Abbreviated Month Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|month\\|.*-stand-alone-abbreviated")
        );
      }
    },
    new Partition.Membership("Narrow Month Names (Format Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|month\\|.*-format-narrow")
        );
      }
    },
    ...
    new Partition.Membership("Abbreviated Day Names") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:format-abbreviated")
        );
      }
    },
    new Partition.Membership("Short Day Names") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:format-short")
        );
      }
    },
    new Partition.Membership("Narrow Day Names") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:stand-alone-narrow")
        );
      }
    },
    new Partition.Membership("Wide Day Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:stand-alone-wide")
        );
      }
    },
    new Partition.Membership("Abbreviated Day Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|day\\|.*:stand-alone-abbreviated")
        );
      }
    },
    new Partition.Membership("Short Day Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:stand-alone-short")
        );
      }
    },
    new Partition.Membership("Narrow Day Names (Format Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|day\\|.*:format-narrow")
        );
      }
    },
    new Partition.Membership("Wide Quarter Names") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|quarter\\|.*-format-wide")
        );
      }
    },
    new Partition.Membership("Abbreviated Quarter Names") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|quarter\\|.*-format-abbreviated")
        );
      }
    },
    new Partition.Membership("Narrow Quarter Names") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|quarter\\|.*-stand-alone-narrow")
        );
      }
    },
    new Partition.Membership("Wide Quarter Names (Stand Alone Context)") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("calendar-.*\\|quarter\\|.*-stand-alone-wide")
        );
      }
    },
    new Partition.Membership(
      "Abbreviated Quarter Names (Stand Alone Context)"
    ) {
      @Override
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null &&
          pp.matches("calendar-.*\\|quarter\\|.*-stand-alone-abbreviated")
        );
      }
    },
    new Partition.Membership("Narrow Quarter Names (Format Context)") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("calendar-.*\\|quarter\\|.*-format-narrow")
        );
      }
    },
    ...
    new Partition.Membership("Flexible Date/Time Formats") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          xpint == -1 || (xp != null && xp.indexOf("availableFormats") > -1)
        );
      }
    },
