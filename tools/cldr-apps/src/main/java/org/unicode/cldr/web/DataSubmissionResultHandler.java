...
/**
 * Callback interface for handling the results of user input changes to survey tool data. The survey
 * tool will call these functions to record changes.
 *
 * @author srl
 */
public interface DataSubmissionResultHandler {
    ...
    /**
     * Note that an item was proposed as an option. Used for UI, to get back the user's previous
     * request.
     *
     * @param p
     * @param choice_v
