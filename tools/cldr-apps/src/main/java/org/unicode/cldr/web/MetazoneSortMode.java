  ...
  private static final Partition.Membership memberships[] = {
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Africa_Central:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Africa_Eastern:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Africa_Southern:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Africa_Western:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|America_Eastern:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|America_Central:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|America_Mountain:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|America_Pacific:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Alaska_Hawaii:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      "Yukon",
      "The Yukon time zone is used by Yukon, Canada since November 2020. " +
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Newfoundland:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Pierre_Miquelon:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Argentina::.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Argentina_Western:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Dutch_Guiana:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|French_Guiana:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Greenland_Eastern:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Greenland_Central:.++")
        );
      }
    },
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Greenland_Western:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      "Casey",
      "The Casey time zone is used by the Casey station in Antarctica. " +
    ...
    new Partition.Membership(
      "Davis",
      "The Davis time zone is used by the Davis station in Antarctica. " +
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|DumontDUrville:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      "Mawson",
      "The Mawson time zone is used by the Mawson station in Antarctica. " +
    ...
    new Partition.Membership(
      "Rothera",
      "The Rothera time zone is used by the Rothera station in Antarctica. " +
      "The time zone is 3 hours behind UTC (UTC-3) and does not use daylight savings time."
    ) {
      @Override
      public boolean isMember(DataRow p) {
    ...
    new Partition.Membership(
      "Syowa",
      "The Syowa time zone is used by the Syowa station in Antarctica. " +
      "The time zone is 3 hours ahead of UTC (UTC+3) and does not use daylight savings time."
    ) {
      @Override
      public boolean isMember(DataRow p) {
    ...
    new Partition.Membership(
      "Vostok",
      "The Vostok time zone is used by the Vostok station in Antarctica. " +
    ...
    new Partition.Membership(
      "Afghanistan",
      "The Afghanistan time zone is used in the country of Afghanistan only. " +
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Afghanistan:.++")
        );
      }
    },
    new Partition.Membership(
      "Aktyubinsk",
      "The Aktyubinsk time zone was used in some areas of Kazakhstan " +
      "until 1991.  It is not currently in use. " +
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Aktyubinsk:.++")
        );
      }
    },
    new Partition.Membership(
      "Almaty",
      "The Almaty time zone was used in some areas of Kazakhstan " +
      "until 2005.  It is not currently in use. " +
      "Daylight savings time was observed in this time zone." +
    ...
    new Partition.Membership(
      "Aqtau",
      "The Aqtau time zone was used in some areas of Kazakhstan " +
      "until 2005.  It is not currently in use. " +
      "Daylight savings time was observed in this time zone." +
    ...
    new Partition.Membership(
      "Aqtobe",
      "The Aqtobe time zone was used in some areas of Kazakhstan " +
      "until 2005.  It is not currently in use. " +
      "Daylight savings time was observed in this time zone." +
      "When DST was not in effect, the time zone was 5 hours ahead of UTC (UTC+5). " +
      "When DST was in effect, the time zone was 6 hours ahead of UTC (UTC+6)."
    ...
    new Partition.Membership(
      "Arabian",
      "The Arabian time zone is used in the countries of Saudi Arabia, " +
      ...
      "especially in Iraq. " +
      "When DST is not in effect, the time zone is 3 hours ahead of UTC (UTC+3). " +
    ...
    new Partition.Membership(
      "Armenia",
      "The Armenia time zone is used in the country of Armenia only. " +
      "Daylight savings time is observed in this time zone. " +
    ...
    new Partition.Membership(
      "Ashkhabad",
      "The Ashkhabad time zone was used in the country of Turkmenistan " +
      "until 1991.  It is not currently in use. " +
      "Daylight savings time was observed in this time zone." +
      "When DST was not in effect, the time zone was 5 hours ahead of UTC (UTC+5). " +
      "When DST was in effect, the time zone was 6 hours ahead of UTC (UTC+6)."
    ...
    new Partition.Membership(
      "Azerbaijan",
      "The Azerbaijan time zone is used in the country of Azerbaijan only. " +
      "Daylight savings time is observed in this time zone. " +
      "When DST is not in effect, the time zone is 4 hours ahead of UTC (UTC+4). " +
      "When DST is in effect, the time zone is 5 hours ahead of UTC (UTC+5)."
    ) {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Azerbaijan:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership(
      "Bangladesh",
      "The Bangladesh time zone is used in the country of Bangladesh only. " +
      "Daylight savings time is observed in this time zone. " +
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Bangladesh:.++")
        );
      }
    },
    new Partition.Membership(
      "Bhutan",
      "The Bhutan time zone is used in the country of Bhutan only. " +
      "The time zone is 6 hours ahead of UTC (UTC+6) and does not use daylight savings time."
    ) {
      @Override
      public boolean isMember(DataRow p) {
    ...
    new Partition.Membership(
      "Borneo",
      "The Borneo time zone was used in the country of Malaysia " +
      "until 1982.  It is not currently in use. " +
      "Daylight savings time was observed in this time zone." +
    ...
    new Partition.Membership(
      "Brunei",
      "The Brunei time zone is used in the country of Brunei only. " +
      "The time zone is 8 hours ahead of UTC (UTC+8) and does not use daylight savings time."
    ) {
      @Override
      public boolean isMember(DataRow p) {
    ...
    new Partition.Membership(
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Choibalsan:.++")
        );
      }
    },
    new Partition.Membership(
    ...
    new Partition.Membership("East Timor", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|East_Timor:.++")
        );
      }
    },
    ...
    new Partition.Membership("Central Indonesia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Indonesia_Central:.++")
        );
      }
    },
    new Partition.Membership("Eastern Indonesia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Indonesia_Eastern:.++")
        );
      }
    },
    new Partition.Membership("Western Indonesia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Indonesia_Western:.++")
        );
      }
    },
    ...
    new Partition.Membership("Eastern Kazakhstan", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("0-names\\|metazone\\|Kazakhstan_Eastern:.++")
        );
      }
    },
    new Partition.Membership("Western Kazakhstan", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("0-names\\|metazone\\|Kazakhstan_Western:.++")
        );
      }
    },
    ...
    new Partition.Membership("Krasnoyarsk", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Krasnoyarsk:.++")
        );
      }
    },
    ...
    new Partition.Membership("Novosibirsk", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Novosibirsk:.++")
        );
      }
    },
    ...
    new Partition.Membership("Philippines", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Philippines:.++")
        );
      }
    },
    ...
    new Partition.Membership("Shevchenko", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Shevchenko:.++")
        );
      }
    },
    ...
    new Partition.Membership("Sverdlovsk", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Sverdlovsk:.++")
        );
      }
    },
    ...
    new Partition.Membership("Tajikistan", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Tajikistan:.++")
        );
      }
    },
    ...
    new Partition.Membership("Turkmenistan", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Turkmenistan:.++")
        );
      }
    },
    ...
    new Partition.Membership("Uzbekistan", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Uzbekistan:.++")
        );
      }
    },
    new Partition.Membership("Vladivostok", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Vladivostok:.++")
        );
      }
    },
    ...
    new Partition.Membership("Yekaterinburg", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Yekaterinburg:.++")
        );
      }
    },
    ...
    new Partition.Membership("Central Australia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Australia_Central:.++")
        );
      }
    },
    new Partition.Membership("Central Western Australia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        ...
        return (
          pp != null &&
          pp.matches("0-names\\|metazone\\|Australia_CentralWestern:.++")
        );
      }
    },
    new Partition.Membership("Eastern Australia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Australia_Eastern:.++")
        );
      }
    },
    new Partition.Membership("Western Australia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Australia_Western:.++")
        );
      }
    },
    ...
    new Partition.Membership("Central Europe", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Europe_Central:.++")
        );
      }
    },
    new Partition.Membership("Eastern Europe", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Europe_Eastern:.++")
        );
      }
    },
    new Partition.Membership("Western Europe", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Europe_Western:.++")
        );
      }
    },
    ...
    new Partition.Membership("Cape Verde", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Cape_Verde:.++")
        );
      }
    },
    ...
    new Partition.Membership("South Georgia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|South_Georgia:.++")
        );
      }
    },
    ...
    new Partition.Membership("French Southern", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|French_Southern:.++")
        );
      }
    },
    new Partition.Membership("Indian Ocean", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Indian_Ocean:.++")
        );
      }
    },
    ...
    new Partition.Membership("Seychelles", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Seychelles:.++")
        );
      }
    },
    ...
    new Partition.Membership("Gilbert Islands", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Gilbert_Islands:.++")
        );
      }
    },
    ...
    new Partition.Membership("Hawaii-Aleutian", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Hawaii_Aleutian:.++")
        );
      }
    },
    ...
    new Partition.Membership("Line Islands", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Line_Islands:.++")
        );
      }
    },
    ...
    new Partition.Membership("Marshall Islands", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Marshall_Islands:.++")
        );
      }
    },
    ...
    new Partition.Membership("New Caledonia", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|New_Caledonia:.++")
        );
      }
    },
    new Partition.Membership("New Zealand", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|New_Zealand:.++")
        );
      }
    },
    ...
    new Partition.Membership("North Mariana Islands", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|North_Mariana:.++")
        );
      }
    },
    ...
    new Partition.Membership("Papua New Guinea", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Papua_New_Guinea:.++")
        );
      }
    },
    new Partition.Membership("Phoenix Islands", "Description TBD") {
      ...
      public boolean isMember(DataRow p) {
        String pp = p.getPrettyPath();
        return (
          pp != null && pp.matches("0-names\\|metazone\\|Phoenix_Islands:.++")
        );
      }
    },
