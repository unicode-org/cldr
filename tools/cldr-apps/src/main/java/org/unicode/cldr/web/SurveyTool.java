...
public class SurveyTool extends HttpServlet {
  ...
  protected void doGet(
    ...
    if (
      SurveyMain.isBusted != null || request.getParameter("_BUSTED") != null
    ) {
  ...
  private static void includeJqueryJavaScript(
    HttpServletRequest request,
    Writer out
  ) throws IOException {
  ...
  private static void includeCldrJavaScript(
    HttpServletRequest request,
    Writer out
  ) throws IOException {
