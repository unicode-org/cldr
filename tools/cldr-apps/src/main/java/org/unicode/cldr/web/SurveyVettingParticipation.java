...
public class SurveyVettingParticipation {
    ...
    public void getJson(SurveyJSONWrapper r) throws SQLException, JSONException {
       ...
       Map<CLDRLocale, Set<CLDRLocale>> intGroups = SurveyMain.getIntGroups();

       Connection conn = null;
       Set<User> noParticipationUsers = new TreeSet<>();
       Set<User> allUserSet = new TreeSet<>();
       ...
       Set<CLDRLocale> badSet = new TreeSet<>(); // set of bad locale IDs
...
//           r.put("allLanguages", JSONWriter.wrap(allLanguages));
       }
           ...
           for (Iterator<CLDRLocale> li = allLanguages.iterator(); li.hasNext();) {
               ...
               if ((group != null) &&
                   ...
                   if (!sm.isValidLocale(lang)) {
                       ...
                       if (!allVettedLocales.contains(lang)) {
