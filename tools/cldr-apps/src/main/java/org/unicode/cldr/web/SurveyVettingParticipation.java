...
public class SurveyVettingParticipation {
  ...
  private static final int STREET_STLEVEL = VoteResolver.Level.street.getSTLevel();
  ...
  public void getJson(SurveyJSONWrapper r) throws SQLException, JSONException {
    ...
    try {
      ...
      while (rsu.next()) {
        ...
        if (
          (theUser.userlevel > STREET_STLEVEL) ||
        ...
        if (
          ...
          (
            ...
            sm
              ...
              .getBaseFromDefaultContent(CLDRLocale.getInstance(group))
          )
        ) {
