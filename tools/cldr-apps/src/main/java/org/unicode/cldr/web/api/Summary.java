...
public class Summary {
  ...
  public Response doVettingSummary(
    ...
    try {
      ...
      if (
        SurveySnapshot.SNAP_CREATE.equals(request.snapshotPolicy) &&
   ...
   */
  private Response getPriorityItemsSummary(
    CookieSession cs,
    SummaryRequest request
  ...
  private SummaryResponse getSummaryResponse(
    ...
    String message = vvq.getPriorityItemsSummaryOutput(
      cs,
      status,
      loadingPolicy,
      sb
  ...
  @APIResponses(
    value = {
      @APIResponse(
        ...
        content = @Content(
          mediaType = "application/json",
          schema = @Schema(implementation = ReviewOutput.class)
        )
      ), // TODO: SummaryResults.class
    }
  )
