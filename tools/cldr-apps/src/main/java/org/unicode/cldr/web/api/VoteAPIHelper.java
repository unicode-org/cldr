    ...
    private static Response handleGetRows(ArgsForGet args) {
        ...
        try {
            ...
            if (args.getDashboard) {
                /*
                 * TODO: implement this -- see Dashboard.getOneRow and VettingViewer.getSinglePathDash
                 * Reference: https://unicode-org.atlassian.net/browse/CLDR-15368
                 */
                return new STError(ErrorCode.E_INTERNAL, "handleGetRows: single-row dashboard not implemented yet").build();
            }
