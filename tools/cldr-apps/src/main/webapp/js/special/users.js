 ...
 * @module users
 */
define("js/special/users.js", ["js/special/SpecialPage.js"], function (
  SpecialPage
) {
  var _super;
  ...
  Page.prototype.show = function show(params) {
    ...
    $.ajax({
      ...
      .done(function (data) {
        ...
        var showLocked = createCheckbox(
          { name: "Hide locked", value: true },
          this
        );
