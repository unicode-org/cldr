 ...
 * @module vsummary
 */
define("js/special/vsummary.js", ["js/special/SpecialPage.js"], function (
  SpecialPage
) {
  var _super;
  ...
  Page.prototype.show = function show(params) {
    ...
    vsContent.appendChild(
      document.createTextNode(cldrText.get("vsContent_initial"))
    );
