    ...
    public class DataRow implements JSONString, PathValueInfo {
        ...
        public class CandidateItem implements Comparable<CandidateItem>, JSONString, CandidateInfo {
                ...
                if (options.contains(EPrintCellSet.doShowValue)) {
                    ...
                    if (value != null) {
                        ...
                        if (true /* !item.itemErrors */) { // exclude item from
                            ...
                            if (ctx.getCanModify()) {
                                /* TODO: should getAdjustedValueHash here be getOriginalValueHash? */
            ...
            public String toJSONString() throws JSONException {
                ...
                JSONObject j = new JSONObject()
                    /* TODO: should this getAdjustedValueHash be getOriginalValueHash? */
        ...
        public String toJSONString() throws JSONException {
            ...
            try {
                ...
                if (winningItem != null) {
                    /* TODO: should getAdjustedValueHash here be getOriginalValueHash? */
                    winningVhash = winningItem.getAdjustedValueHash();
                }
                String voteVhash = "";
                String ourVote = null;
                if (userForVotelist != null) {
                ...
                for (CandidateItem i : items.values()) {
                     ...
                     */
                    itemsJson.put(i.getOriginalValueHash(), i);
                }
