...
public class InterestSort extends SortMode {
	...
	Membership[] memberships() {
        //return (SurveyMain.isPhaseSubmit()||SurveyMain.isPhaseVetting())?submitMemberships:vettingMemberships;
		return memberships;
	}
...
//	        }
	...
	private static Partition.Membership memberships[] = {                 
			new Partition.Membership("Errors") { 
