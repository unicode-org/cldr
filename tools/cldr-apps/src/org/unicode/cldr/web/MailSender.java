...
/*    public static void sendMail(String to, String subject, String body) {
    ...
    */
     ...
     */
    public static synchronized void sendMail(String x, String mailFromAddress, String mailFromName, String from, String to, String subject, String body) {
...
//            System.err.println("Not emailing admin.");
     ...
     * @param body mail body
     */
    public static synchronized void sendMail(String x, String mailFromAddress, String mailFromName, String from, Message.RecipientType recipType, Set<String> bcc, String subject, String body) {
        if(bcc==null||bcc.isEmpty()||bcc.size()<countLimit) {
            ...
            for(String s : bcc) {
                ...
                if(subSet.size()==countLimit) {
                    //System.err.println(" -- breaking up mail into " + subSet.size() + " recips");
                    sendMailInternal(x, mailFromAddress, mailFromName, from, recipType, subSet, subject, body);
                    subSet.clear();
                }
            }
            if(!subSet.isEmpty()) {
                //System.err.println(" -- breaking up mail into " + subSet.size() + " recips, last chunk");
                sendMailInternal(x, mailFromAddress, mailFromName, from, recipType, subSet, subject, body);
            }
        }
    }

    public static synchronized void sendMailInternal(String x, String mailFromAddress, String mailFromName, String from, Message.RecipientType recipType, Set<String> bcc, String subject, String body) {
        String typeStr = "?";
        final String smtp = getInstance().CLDR_SMTP;
    ...
    public void run() {
        ...
        setName("SurveyTool Mail Sender: processing, queue " + messageQueue.size());
                //System.err.println("Mail: run() (queue size " + messageQueue.size()+")");
