...
public class TestAnnotationVotes extends TestFmwk {
    ...
    /**
     * Test features related to adjustAnnotationVoteCounts in VoteResolver.java. Note: the name of
     * each function must begin with "Test", or it will be ignored! See TestFmwk.java.
     */
    public void TestAV00() {
        ...
        // TODO: logln instead of System.out.println -- but how to make it display in log? Set
        // "level" or "verbose" somewhere?
    ...
    public void TestAV04() {
        String test =
                "adjustAnnotationVoteCounts for a|b|c|f=8, a|b|e=6, a|e=4 should make a|b|e, a|e, a|b|c|f";
    ...
    public void TestAV05() {
         ...
         */
        String test =
                "adjustAnnotationVoteCounts for a=12, b|c=8, b|c|d=8 should make b|c, b|c|d, a";
    ...
    public void TestAV06() {
        String test =
                "adjustAnnotationVoteCounts for a|b|c=8, a|b|d=6, a|d=4 should make a|b|d, a|d, a|b|c";
    ...
    public void TestAV07() {
        String test =
                "adjustAnnotationVoteCounts for a=24, b|c=20, b|c|d=20 should make b|c, b|c|d, a";
        String[] valI = {"a", "b|c", "b|c|d"}; // input
    ...
    public void TestAV08() {
        ...
        String test =
                "adjustAnnotationVoteCounts for hmyz | malárie | moskyt | štípnutí | virus, dengue | hmyz | malárie | moskyt | štípnutí | virus ...";
        String[] valI = {
            "hmyz | malárie | moskyt | štípnutí | virus",
            "dengue | hmyz | malárie | moskyt | štípnutí | virus"
        }; // input
    ...
    public void TestAV09() {
        ...
        String test =
                "adjustAnnotationVoteCounts for b|c|d|e|f=4, a|b|c|d|e|f=8 should make a|b|c|d|e|f, b|c|d|e|f";
    ...
    public void TestAV10() {
        ...
        String test =
                "adjustAnnotationVoteCounts for b|c|d|e|f=4, a|b|c|d|e|f=6 should make a|b|c|d|e|f, b|c|d|e|f";
        String[] valI = {"b|c|d|e|f", "a|b|c|d|e|f"}; // input
    ...
    public void TestAV11() {
        ...
        String test =
                "adjustAnnotationVoteCounts for b|c|d|e|f=4, a|b|c|d|e|f=5 should make b|c|d|e|f, a|b|c|d|e|f";
        String[] valI = {"b|c|d|e|f", "a|b|c|d|e|f"}; // input
    ...
    public void TestAV12() {
        ...
        String test =
                "adjustAnnotationVoteCounts for a|b=4, a|b|d=8, a|b|c=8 should make a|b|c, a|b|d, a|b";
    ...
    public void TestAV13() {
        String test =
                "adjustAnnotationVoteCounts for a|b=4, a|b|d=8, a|b|c=7 should make a|b|d, a|b|c, a|b";
        String[] valI = {"a|b", "a|b|d", "a|b|c"}; // input
    ...
    public void TestAV17() {
        ...
        String test =
                "adjustAnnotationVoteCounts for a|b=4, a|b|c|d=8, a|b|e=8 should make a|b|e, a|b|c|d, a|b";
    ...
    public void TestAV18() {
        ...
        String test =
                "adjustAnnotationVoteCounts for a|b|c|d=8, a|b|e=8 should make a|b|e, a|b|c|d";
    ...
    public void TestAV19() {
        ...
        String test =
                "adjustAnnotationVoteCounts for a|b=4, a|b|c|d|e|f|g|h=9, a|b|c|x|y=8 should make a|b|c|x|y, a|b, a|b|c|d|e|f|g|h";
    ...
    /**
     * Run adjustAnnotationVoteCounts with the given input and expected output. Test whether the
     ...
     *     <p>Note: there is no array of expected output vote counts. Treat the test as passing or
     *     failing based only on the order of output values, not on the exact output vote counts.
     */
    private void runTest(String test, String[] valI, long[] votesI, String[] valO) {
        ...
        // Convert sets to strings for comparison, otherwise the set.equals() function ignores
