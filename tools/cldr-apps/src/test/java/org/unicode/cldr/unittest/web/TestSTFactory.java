...
public class TestSTFactory extends TestAll {
    ...
    private String expect(String path, String expectString, boolean expectVoted, CLDRFile file, BallotBox<User> box) throws UserRegistry.LogoutException, SQLException {
    ...
    @Test
    public void testBasicVote() throws SQLException, UserRegistry.LogoutException, IOException, InvalidXPathException, VoteNotAcceptedException {
        STFactory fac = getFactory();
    ...
    @Test
    public void testSparseVote() throws SQLException, IOException, InvalidXPathException, SurveyException, LogoutException {
        STFactory fac = getFactory();
...
//                    <!ATTLIST verifyUser action ( create | delete | modify | list ) #REQUIRED>
                    ...
                    case "create":
                        ...
                        assertEquals(newTest, oldTest, "New(ex) vs old(got) create test: " + uLevel + "/" + onLevel);
                    ...
                    case "modify": {
                        ...
                        assertEquals(newTest, oldTest, "New(ex) vs old(got) manage test: " + uLevel + "/" + onLevel);
                        actualResult = actualResult && newTest;
                    }
                        break;
                    default:
                    ...
                    assertEquals(allowed, actualResult, u.org + ":" + uLevel + " " + action + " " + onUser.org + ":" + onLevel);
                }
                    break;
                case "echo":
                case "warn":
        ...
        final String dataPath = "data/" + fileName;
        final Object dataFile = TestSTFactory.class.getResource(dataPath);
        assertNotNull(dataFile, "Resource @ " + dataPath);
        myReader.read(dataFile.toString(), TestAll.getUTF8Data(fileName), -1, true);
    }

    @Test
    public void testVettingWithNonDistinguishing() throws UserRegistry.LogoutException, SQLException, IOException, InvalidXPathException, SurveyException {
        STFactory fac = getFactory();
    ...
    public UserRegistry.User getMyUser() throws UserRegistry.LogoutException, java.sql.SQLException {
        if (gUser == null) {
