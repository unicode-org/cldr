...
public class Compacter {
     ...
     * @param set2 input is collection of strings, where each string is exactly one codepoint. The
     *     collection is read in Iterator order.
     */
     ...
     * @return result list of strings, where each string is exactly one codepoint. The order is
     *     exactly the same as the input to compaction, although the collection may be different.
     */
