 ...
 * "E12" or "C00").
 *
 * <p>It is important to note that the physical placement of the keys is not encoded in this enum,
 * rather what is important is their logical placement using the ISO convention.
 *
 * <p>We can also extend the ISO Layout convention by adding rows as we please (such as adding an F
 ...
 * purposes.
 *
 * <p>More information about the ISO layout positions can be found in the <a
