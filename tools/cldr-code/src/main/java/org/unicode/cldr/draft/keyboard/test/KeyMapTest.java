...
public class KeyMapTest extends TestFmwk {
    ...
    private static KeyMap createKeyMap() {
        ModifierKeyCombination combination1 =
        ...
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination1, combination2));
        CharacterMap characterMap1 =
                CharacterMap.of(
                        IsoLayoutPosition.C03, "A", ImmutableList.of("$", "%", "\uD800\uDE80"));
    ...
    public void testModifierKeyCombinationSet() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(EnumSet.of(ModifierKey.SHIFT));
        ModifierKeyCombinationSet combinationSetTest =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination1, combination2));
    ...
    public void testIsoLayoutToCharacterMap() {
        CharacterMap characterMap1 =
                CharacterMap.of(
                        IsoLayoutPosition.C03, "A", ImmutableList.of("$", "%", "\uD800\uDE80"));
        CharacterMap characterMap2 = CharacterMap.of(IsoLayoutPosition.C02, "S");
        ImmutableMap<IsoLayoutPosition, CharacterMap> isoLayoutToCharacterMap =
                ImmutableMap.of(
    ...
    public void testEqualsFalse() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ...
                        ImmutableSet.of(ModifierKey.OPTION_RIGHT));
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination1));
        CharacterMap characterMap1 =
                CharacterMap.of(IsoLayoutPosition.C03, "B", ImmutableList.of("$", "%"));
        CharacterMap characterMap2 = CharacterMap.of(IsoLayoutPosition.C02, "W");
        KeyMap keyMapTest =
                KeyMap.of(combinationSet, ImmutableSet.of(characterMap1, characterMap2));
    ...
    public void testCompareToGreater() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(EnumSet.noneOf(ModifierKey.class));
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination));
    ...
    public void testCompareToLess() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(EnumSet.of(ModifierKey.COMMAND));
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination));
        KeyMap keyMapTest = KeyMap.of(combinationSet, ImmutableSet.<CharacterMap>of());
        assertTrue("", keyMap.compareTo(keyMapTest) < 0);
