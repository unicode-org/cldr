...
public class KeyboardTest extends TestFmwk {
    ...
    private static Keyboard createKeyboard() {
        ...
        CharacterMap characterMap2 =
                CharacterMap.of(IsoLayoutPosition.E03, "š", ImmutableList.of("ç %"));
        ...
        CharacterMap characterMap5 =
                CharacterMap.of(IsoLayoutPosition.C03, "ß", ImmutableList.of("Ð"));
        ...
        return Keyboard.of(
                KeyboardId.fromString("cs-t-k0-osx-qwerty"),
                ImmutableList.of("Czech-QWERTY"),
                ImmutableSortedSet.of(keyMap1, keyMap2),
                transforms);
    }
    ...
    public void testKeyboardId() {
        ...
        KeyboardId testId =
                KeyboardId.of(
                        ULocale.forLanguageTag("cs"), Platform.OSX, ImmutableList.of("qwerty"));
    ...
    public void testTransforms() {
        ImmutableSet<Transform> transforms =
                ImmutableSet.of(
                        Transform.of("¨ß", "\uD800\uDE80"),
                        Transform.of("¨š", "s"),
                        Transform.of("\u0302ß", "\u0305a"));
