...
public class ModifierKeyCombinationSetTest extends TestFmwk {
    ...
    public void testOfWithSingleCombination() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.<ModifierKey>of());
    ...
    public void testOfWithMultipleCombinations() {
        ...
        ModifierKeyCombination combination3 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(
                                ModifierKey.CONTROL_LEFT,
                                ModifierKey.CONTROL_RIGHT,
                                ModifierKey.CAPSLOCK),
                        ImmutableSet.of(ModifierKey.ALT));
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(
                        ImmutableSet.of(combination1, combination2, combination3));
        assertEquals(
                "",
                ImmutableSortedSet.of(combination1, combination2, combination3),
                combinationSet.combinations());
        assertEquals(
                "",
                "ctrlL+ctrlR+caps+alt? ctrl+optR+cmd?+shiftL? cmd+shift+ctrl?",
    ...
    public void testOfWithSimplification() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(
                                ModifierKey.ALT_RIGHT, ModifierKey.COMMAND, ModifierKey.SHIFT_LEFT),
        ...
        ModifierKeyCombination simplifiedCombination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.ALT_RIGHT, ModifierKey.COMMAND),
                        ImmutableSet.of(ModifierKey.SHIFT));
        assertEquals(
                "", ImmutableSortedSet.of(simplifiedCombination), combinationSet.combinations());
    ...
    public void testOfWithMultipleSimplifications() {
        ...
        ModifierKeyCombination simplifiedCombination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.ALT_RIGHT, ModifierKey.COMMAND),
                        ImmutableSet.of(ModifierKey.SHIFT));
        ModifierKeyCombination simplifiedCombination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.CONTROL, ModifierKey.ALT_LEFT),
    ...
    public void testOfWithCascadingSimplifications() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(
                                ModifierKey.SHIFT,
                                ModifierKey.OPTION_LEFT,
                                ModifierKey.OPTION_RIGHT));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.OPTION_RIGHT));
        ModifierKeyCombination combination3 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT),
                        ImmutableSet.of(ModifierKey.OPTION_LEFT));
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(
                        ImmutableSet.of(combination1, combination2, combination3));
        ModifierKeyCombination simplifiedCombination =
    ...
    public void testCombine() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.OPTION_RIGHT, ModifierKey.CONTROL),
                        ImmutableSet.of(ModifierKey.COMMAND, ModifierKey.SHIFT_LEFT));
        ModifierKeyCombinationSet combinationSet1 =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination1, combination2));
        ModifierKeyCombination combination3 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.CAPSLOCK, ModifierKey.OPTION),
                        ImmutableSet.of(ModifierKey.CONTROL));
        ModifierKeyCombinationSet combinationSet2 =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination3));
        ModifierKeyCombinationSet finalSet =
                ModifierKeyCombinationSet.combine(
                        Lists.newArrayList(combinationSet1, combinationSet2));
        assertEquals(
                "",
                ImmutableSortedSet.of(combination1, combination2, combination3),
                finalSet.combinations());
        assertEquals(
                "", "opt+caps+ctrl? ctrl+optR+cmd?+shiftL? cmd+shift+ctrl?", finalSet.toString());
    }
    ...
    public void testCompareToWithSimpleCombinations() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.COMMAND));
        ModifierKeyCombinationSet combinationSet2 =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination2));
    ...
    public void testCompareToWithDifferentSizeCombinations() {
        ...
        ModifierKeyCombination combination3 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT), ImmutableSet.of(ModifierKey.CONTROL));
        ModifierKeyCombinationSet combinationSet2 =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination2, combination3));
        assertTrue("", combinationSet1.compareTo(combinationSet2) < 0);
    }
    ...
    public void testIsBaseForComplexCombinations() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ...
                        ImmutableSet.of(
                                ModifierKey.COMMAND, ModifierKey.ALT_LEFT, ModifierKey.CONTROL));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.COMMAND),
    ...
    public void testEqualsTrue() {
        ...
        ModifierKeyCombinationSet combinationSet =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combination1, combination2));
        ModifierKeyCombination combinationTest1 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.SHIFT));
        ModifierKeyCombination combinationTest2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.COMMAND),
                        ImmutableSet.of(ModifierKey.ALT_LEFT));
        ModifierKeyCombinationSet combinationSetTest =
                ModifierKeyCombinationSet.of(ImmutableSet.of(combinationTest1, combinationTest2));
    ...
    public void testEqualsFalse() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.CAPSLOCK));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.COMMAND),
                        ImmutableSet.of(ModifierKey.ALT_LEFT));
