...
public class ModifierKeyCombinationTest extends TestFmwk {
    ...
    public void testOfOnKeysForComplexCombination() {
        ...
        assertEquals("", onKeys, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
                ImmutableSet.of(ModifierKey.ALT_LEFT, ModifierKey.OPTION, ModifierKey.COMMAND);
        assertEquals("", offKeys, combination.offKeys());
    ...
    public void testOfOnKeysForComplexCombinationWithVariant() {
        ...
        ImmutableSet<ModifierKey> onKeys =
                ImmutableSet.of(
                        ModifierKey.SHIFT_RIGHT, ModifierKey.ALT_RIGHT, ModifierKey.CAPSLOCK);
        assertEquals("", onKeys, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
                ImmutableSet.of(
                        ModifierKey.CONTROL,
                        ModifierKey.ALT_LEFT,
                        ModifierKey.OPTION,
                        ModifierKey.COMMAND);
        assertEquals("", offKeys, combination.offKeys());
    ...
    public void testOfOnAndDontCareKeys_complex() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(
                                ModifierKey.CONTROL, ModifierKey.SHIFT, ModifierKey.CAPSLOCK),
        ...
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(
                                ModifierKey.CONTROL, ModifierKey.SHIFT, ModifierKey.CAPSLOCK),
                        ImmutableSet.of(
                                ModifierKey.ALT, ModifierKey.ALT_RIGHT, ModifierKey.COMMAND));
        ImmutableSet<ModifierKey> onKeys =
                ImmutableSet.of(ModifierKey.CONTROL, ModifierKey.SHIFT, ModifierKey.CAPSLOCK);
        assertEquals("", onKeys, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
                ImmutableSet.of(ModifierKey.OPTION, ModifierKey.ALT_LEFT);
        assertEquals("", offKeys, combination.offKeys());
    ...
    public void testEqualsFalse() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.ALT_RIGHT));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(
    ...
    public void testCompareToForOnKeys() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.OPTION));
        // Expected: [caps, opt]
    ...
    public void testCompareToForCloseOnKeys() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.ALT_RIGHT, ModifierKey.CAPSLOCK));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(
                                ModifierKey.SHIFT, ModifierKey.ALT_RIGHT, ModifierKey.CAPSLOCK));
    ...
    public void testCompareToForLeftAndRightVariants() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.CONTROL_LEFT));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.CONTROL_RIGHT));
        ModifierKeyCombination combination3 =
                ModifierKeyCombination.ofOnKeys(ImmutableSet.of(ModifierKey.CONTROL));
    ...
    public void testCompareToWithLeftRightVariantDontCares() {
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ...
                        ImmutableSet.of(ModifierKey.CONTROL_LEFT));
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT),
