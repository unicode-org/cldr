...
public class ModifierKeySimplifierTest extends TestFmwk {
    ...
    public void testSimplifyInputWithParentOn() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.ALT, ModifierKey.CAPSLOCK));
    ...
    public void testSimplifyInputWithChildOn() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.OPTION_LEFT, ModifierKey.COMMAND));
        ImmutableSet<ModifierKey> onKeys =
                ImmutableSet.of(ModifierKey.OPTION_LEFT, ModifierKey.COMMAND);
        assertEquals("", onKeys, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
                ImmutableSet.of(
    ...
    public void testSimplifyInputWithBothChildrenOn() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.SHIFT_LEFT, ModifierKey.SHIFT_RIGHT));
        ImmutableSet<ModifierKey> onKeys =
                ImmutableSet.of(ModifierKey.SHIFT_LEFT, ModifierKey.SHIFT_RIGHT);
        assertEquals("", onKeys, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
    ...
    public void testSimplifyInputWithParentDontCare() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EMPTY_SET, ImmutableSet.of(ModifierKey.SHIFT));
    ...
    public void testSimplifyInputWithChildDontCare() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EMPTY_SET, ImmutableSet.of(ModifierKey.CONTROL_RIGHT));
        assertEquals("", EMPTY_SET, combination.onKeys());
        ImmutableSet<ModifierKey> offKeys =
                ImmutableSet.of(
                        ModifierKey.SHIFT,
    ...
    public void testSimplifyToStringWithChildDontCareAndOn() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.SHIFT_LEFT),
    ...
    public void testSimplifyToStringWithChildDontCare() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EMPTY_SET, ImmutableSet.of(ModifierKey.OPTION_RIGHT));
    ...
    public void testSimplifyToStringWithComplexCombination() {
        ModifierKeyCombination combination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(
                                ModifierKey.CONTROL, ModifierKey.ALT_RIGHT, ModifierKey.COMMAND),
                        ImmutableSet.of(
                                ModifierKey.OPTION, ModifierKey.CAPSLOCK, ModifierKey.SHIFT_LEFT));
        assertEquals(
                "",
                "cmd+ctrl+altR+opt?+caps?+shiftL?",
    ...
    public void testSimplifySetWithIdentical() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        ImmutableSet.of(ModifierKey.CONTROL, ModifierKey.CAPSLOCK),
                        ImmutableSet.of(ModifierKey.SHIFT_RIGHT));
        ImmutableSet<ModifierKeyCombination> result =
                ModifierKeySimplifier.simplifySet(ImmutableSet.of(combination1, combination2));
    ...
    public void testSimplifySetWithSingleOnKey() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(
                        ImmutableSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT));
        // 1 + 0 = ?
        ImmutableSet<ModifierKeyCombination> result =
                ModifierKeySimplifier.simplifySet(ImmutableSet.of(combination1, combination2));
        // altR+shift+caps?
        ModifierKeyCombination resultCombination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.CAPSLOCK));
    ...
    public void testSimplifySetWithParentOnKey() {
        ...
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT, ModifierKey.CONTROL));
        // altR+shift
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT));
        ...
        ModifierKeyCombination resultCombination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.CONTROL));
        assertEquals("", ImmutableSet.of(resultCombination), result);
    }
    ...
    public void testSimplifySetWithSingleOffKey() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.COMMAND));
        // 0 + ? = ?
        ImmutableSet<ModifierKeyCombination> result =
                ModifierKeySimplifier.simplifySet(ImmutableSet.of(combination1, combination2));
        // altR+shift+cmd?
    ...
    public void testSimplifySetWithChildOnKey() {
        ...
        ModifierKeyCombination resultCombination =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.CONTROL_LEFT));
        assertEquals("", ImmutableSet.of(resultCombination), result);
    }
    ...
    public void testSimplifySetWithTwoDifferentChildrenDontCare() {
        ...
        ModifierKeyCombination combination1 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.CONTROL_RIGHT));
        // altR+shift+ctrlL?
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
    ...
    public void testSimplifySetWithParentDontCareAndChildDontCare() {
        ...
        ModifierKeyCombination combination2 =
                ModifierKeyCombination.ofOnAndDontCareKeys(
                        EnumSet.of(ModifierKey.SHIFT, ModifierKey.ALT_RIGHT),
                        EnumSet.of(ModifierKey.OPTION_RIGHT));
        // ??? + ?0? = ???
        ImmutableSet<ModifierKeyCombination> result =
                ModifierKeySimplifier.simplifySet(ImmutableSet.of(combination1, combination2));
        // altR+shift+opt?
