...
public class POSIX_LCCollate {
    ...
    public POSIX_LCCollate(
        ...
        for (UnicodeSetIterator it = new UnicodeSetIterator(chars); it.next(); ) {
            ...
            if (CharNameLength > longest_char) longest_char = CharNameLength;
        }
    ...
    public void write(PrintWriter out) {
        ...
        out.print("UNDEFINED");
        for (int i = longest_char - 9; i > 0; i--) out.print(" ");
        out.print(" ");
    ...
    private String showLine(RuleBasedCollator col, String string) {
        ...
        for (int i = longest_char - ThisChar.length(); i > 0; i--) result.append(" ");
        result.append(" ");
        // gather data
    ...
    private class Weights {
        ...
        @Override
        public int hashCode() {
            return (primaries.hashCode() * 37 + secondaries.hashCode()) * 37
                    + tertiaries.hashCode();
        }
    }
