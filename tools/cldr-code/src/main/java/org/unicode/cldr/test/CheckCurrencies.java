...
public class CheckCurrencies extends CheckCLDR {
    ...
    public CheckCLDR handleCheck(
        ...
        if (value != null && value.length() > 5) {
            ...
            // if (path.indexOf("[@type=\"INR\"]") >= 0) { // skip INR, since it is typically a
            // choice (could do more
            ...
            result.add(
                    new CheckStatus()
                            ...
                            .setSubtype(Subtype.currencySymbolTooWide) // typically warningType or
                            // errorType
                            .setMessage("Currency symbol length > 5")); // the message; can be
