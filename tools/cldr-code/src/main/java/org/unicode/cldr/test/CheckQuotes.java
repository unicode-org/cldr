...
public class CheckQuotes extends CheckCLDR {
    public static final String VALID_DELIMITER_URL =
    ...
    private static final UnicodeSet VALID_DELIMITERS =
            new UnicodeSet()
                    .add(0x2018, 0x201A)
                    .add(0x201C, 0x201E)
                    .add(0x300C, 0x300F)
            ...
            if (matcher.find()) {
                result.add(
                        new CheckStatus()
                                ...
                                .setMessage(
                                        "Use of ASCII quote marks (' \") is discouraged. Use primes for units (′ ″) and curly quotes for text (‘ ’ “ ” …)"));
            }
        }
