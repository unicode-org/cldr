...
/* TODO: this file was hand-edited as a temporary work-around. The first set of putAll calls was generated
 * by GenerateExampleDependencies.java on 2026-04-30. It was smaller than expected, compared with earlier
 * versions, for reasons unknown, still to be investigated. Instead of simply replacing the old generated file
 * with the new generated file, the old and new files were combined by copying and pasting the old putAll calls
 * beneath the new putAll calls. The combination includes some duplicates and possibly some obsolete dependencies,
 * but should result in correct Survey Tool behavior, at the expense of some inefficiency.
 *
 * The old putAll calls start below the comment on line 797 of this file.
 *
 * Reference: https://unicode-org.atlassian.net/browse/CLDR-19035 */
    ...
    public static ImmutableSetMultimap<String, String> dependencies =
            new ImmutableSetMultimap.Builder<String, String>()
                    ...
                    .putAll(
                            ...
                            "//ldml/dates/calendars/calendar[@type=\"([^\"]*+)\"]/dayOfMonths/dayOfMonthContext[@type=\"([^\"]*+)\"]/dayOfMonthWidth[@type=\"([^\"]*+)\"]/dayOfMonth[@ordinal=\"([^\"]*+)\"]",
                    ...
                    .putAll(
                            ...
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                            "//ldml/dates/calendars/calendar[@type=\"([^\"]*+)\"]/dateTimeFormats/intervalFormats/intervalFormatRanges/intervalFormatRange[@type=\"([^\"]*+)\"]",
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                    ...
                    .putAll(
                            ...
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                            "//ldml/dates/timeZoneNames/dualOffsetFormat",
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                    ...
                    .putAll(
                            ...
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                            "//ldml/dates/timeZoneNames/gmtFormat[@alt=\"([^\"]*+)\"]",
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                            "//ldml/dates/timeZoneNames/gmtUnknownFormat",
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                            "//ldml/dates/timeZoneNames/gmtUnknownFormat[@alt=\"([^\"]*+)\"]",
                            "//ldml/personNames/personName[@order=\"([^\"]*+)\"][@length=\"([^\"]*+)\"][@usage=\"([^\"]*+)\"][@formality=\"([^\"]*+)\"]/namePattern")
                    .putAll(
                    ...
                    /* The putAll calls below are copied from the version of this file dated 2025-12-18 (commit 959829f) */
