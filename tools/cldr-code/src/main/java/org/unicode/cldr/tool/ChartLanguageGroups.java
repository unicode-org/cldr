...
public class ChartLanguageGroups extends Chart {
    ...
    public void writeContents(FormattedFileWriter pw) throws IOException {
        ...
        Multimap<String, String> lg =
                CLDRConfig.getInstance().getSupplementalDataInfo().getLanguageGroups();
    ...
    private void show(Multimap<String, String> lg, String parent, TablePrinter tablePrinter) {
        ...
        TreeSet<Pair<String, String>> nameAndCode =
                new TreeSet<>(
    ...
    private void addRow(
            String parent, TablePrinter tablePrinter, String marker, StringBuilder treeList) {
        tablePrinter
                .addRow()
                .addCell(parent)
    ...
    private String getLangName(String langCode) {
        return langCode.equals(LocaleNames.MUL)
                ? "All"
                : langCode.equals("zh")
                        ? "Mandarin Chinese"
                        : ENGLISH.nameGetter()
