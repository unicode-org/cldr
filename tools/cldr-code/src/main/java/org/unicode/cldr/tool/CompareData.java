...
public class CompareData {
    ...
    private static final int HELP1 = 0, HELP2 = 1, SOURCEDIR = 2, DESTDIR = 3, MATCH = 4;
        ...
        try {
            ...
            for (Iterator<String> it = locales.iterator(); it.hasNext(); ) {
                ...
                try {
                    ...
                    pathsSeen.clear();
                    for (Iterator<String> it2 = file.iteratorDefault(); it2.hasNext(); ) {
                    ...
                    for (Iterator<String> it2 = oldFile.iteratorDefault(); it2.hasNext(); ) {
                        String path = it2.next();
                    ...
                    newItems = size(file.iteratorDefault());
                }
                String langScript =
