...
public class FindHardInheritance {
    static final class Info {
        ...
        public Info(
                ...
                int coverageCount,
                int regularCountCps,
                int inheritedCountCps,
                int redundantCountCps,
                int constructedCountCps,
                int coverageCountCps) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dir." + "\t" + "locale" + "\t" + Info.HEADER);
    ...
    private static Info getCounts(
            String dir, Factory factory, String localeId, Output<Info> cpsInfo) {
