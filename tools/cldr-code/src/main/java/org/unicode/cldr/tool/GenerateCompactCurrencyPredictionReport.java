        ...
        try (PrintWriter out = new PrintWriter(new FileWriter(outputPath))) {
            ...
            for (String locale : locales) {
                ...
                for (String ns : numberingSystems) {
                    ...
                    Template alphaTemplate = parseStandardPattern(stdCurrAlphaPattern != null ? stdCurrAlphaPattern : stdCurrPattern);
                    ...
                    for (String power : POWERS) {
                        for (String count : COUNTS) {
                            String decCompPath = "//ldml/numbers/decimalFormats[@numberSystem=\"" + ns + "\"]/decimalFormatLength[@type=\"short\"]/decimalFormat[@type=\"standard\"]/pattern[@type=\"" + power + "\"][@count=\"" + count + "\"]";
                            String accsPath = "//ldml/numbers/currencyFormats[@numberSystem=\"" + ns + "\"]/currencyFormatLength[@type=\"short\"]/currencyFormat[@type=\"standard\"]/pattern[@type=\"" + power + "\"][@count=\"" + count + "\"]";
                            String accsAlphaPath = "//ldml/numbers/currencyFormats[@numberSystem=\"" + ns + "\"]/currencyFormatLength[@type=\"short\"]/currencyFormat[@type=\"standard\"]/pattern[@type=\"" + power + "\"][@count=\"" + count + "\"][@alt=\"alphaNextToNumber\"]";
                            ...
                            String targetActualAlpha = actualCurrCompAlpha != null ? actualCurrCompAlpha : actualCurrComp;
