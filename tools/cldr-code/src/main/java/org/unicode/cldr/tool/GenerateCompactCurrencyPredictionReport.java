                ...
                for (String ns : numberingSystems) {
                    ...
                    for (String power : POWERS) {
                        for (String count : COUNTS) {
                            ...
                            String actualCurrCompAlpha =
                                    resolvedCldrFile.getStringValue(accsAlphaPath);

                            if (decCompPattern == null
                                    && actualCurrComp == null
                                    && actualCurrCompAlpha == null) {
                            ...
                            if (actualCurrComp == null && predictedStd == null) {
                                stdMatch = true;
                            } else if (actualCurrComp != null
                                    && actualCurrComp.equals(predictedStd)) {
                                stdMatch = true;
                            }
                            ...
                            if (targetActualAlpha == null && predictedAlpha == null) {
                                alphaMatch = true;
                            } else if (targetActualAlpha != null
                                    && targetActualAlpha.equals(predictedAlpha)) {
                                alphaMatch = true;
                            }
