...
public class GenerateLanguageMatches {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Map<LstrField, String>> lstr =
        ...
        List<R4<String, String, Integer, Boolean>> matchData =
                SDI.getLanguageMatcherData("written_new");
        ...
        for (Entry<String, String> entry : macroToEncompassed.entries()) {
            ...
            if (macroLanguage.equals("ku")) {
                continue; // these are problematic, since they shift scripts; also, might be better
                // to fall back to ar/fa
            }
    ...
    static final Transform<String, String> MENU =
