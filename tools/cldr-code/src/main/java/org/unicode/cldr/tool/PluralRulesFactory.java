...
public abstract class PluralRulesFactory extends PluralRules.Factory {
    ...
    private static ConcurrentHashMap<Pair<Type, String>, PluralRulesFactory> singletons =
            new ConcurrentHashMap<>();

    public static PluralRulesFactory getInstance(
            SupplementalDataInfo supplementalDataInfo, Type type) {
        Pair<Type, String> key =
                new Pair<>(type, supplementalDataInfo.getDirectory().getAbsolutePath());
    ...
    private void loadData() {
        //        LinkedHashMap<ULocale, PluralMinimalPairs> temp = new LinkedHashMap<ULocale,
        // PluralMinimalPairs>();
        //        HashMap<ULocale, PluralRules> tempOverrides = new HashMap<ULocale, PluralRules>();
        Relation<ULocale, DecimalQuantity> tempSamples =
                Relation.of(new HashMap<ULocale, Set<DecimalQuantity>>(), HashSet.class);
        ...
        //                PluralType type = "pluralMinimalPairs".equals(element) ?
        // PluralType.CARDINAL
        //                    : "ordinalMinimalPairs".equals(element) ? PluralType.ORDINAL
        //                        : null;
        //                PluralInfo.Count category = PluralInfo.Count.valueOf(
        //                    parts.getAttributeValue(-1, type == PluralType.CARDINAL ? "count" :
        // "ordinal"));
        ...
        //            }
        //            //System.out.println("*Adding sample:\t" + locale + "\t" + keyword + "\t" +
        // sample);
        //            samplePatterns.put(locale, PluralType.CARDINAL, Count.valueOf(keyword),
        // sample);
        //        }
        ...
        //            //System.out.println("*Adding ordinal sample:\t" + locale + "\t" + count +
        // "\t" + sample + "\t" + integerValue);
        ////            try {
        ////                samplePatterns.put(locale, PluralType.ORDINAL, count, sample);
        ////            } catch (Exception e) {
        ...
        for (String[] pair : EXTRA_SAMPLE_SOURCE) {
            for (String locale : pair[0].split("\\s*,\\s*")) {
                ...
                for (String item : pair[1].split("\\s*,\\s*")) {
                    tempSamples.put(
                            uLocale, DecimalQuantity_DualStorageBCD.fromExponentString(item));
                }
            }
        }
    ...
    //        {"af", "one: n is 1"},
    //        {"am", "one: n in 0..1"},
    //        {"ar", "zero: n is 0;  one: n is 1;  two: n is 2;  few: n mod 100 in 3..10;  many: n
    // mod 100 in 11..99"},
    //        {"az", "other: null"},
    //        {"bg", "one: n is 1"},
    //        {"bn", "one: n is 1"},
    ...
    //        {"gu", "one: n is 1"},
    //        {"hi", "one: n in 0..1"},
    //        {"hr", "one: n mod 10 is 1 and n mod 100 is not 11;  few: n mod 10 in 2..4 and n mod
    // 100 not in 12..14;  many: n mod 10 is 0 or n mod 10 in 5..9 or n mod 100 in 11..14"},
    //        {"hu", "other: null"},
    //        {"hy", "one: n is 1"},
    //        {"id", "other: null"},
    //        {"is", "one: n is 1"},
    ...
    //        {"ky", "one: n is 1"},
    //        {"lo", "other: null"},
    //        {"lt", "one: n mod 10 is 1 and n mod 100 not in 11..19;  few: n mod 10 in 2..9 and n
    // mod 100 not in 11..19"},
    ...
    //        {"no", "one: n is 1"},
    //        {"pa", "one: n is 1"},
    //        {"pl", "one: n is 1;  few: n mod 10 in 2..4 and n mod 100 not in 12..14;  many: n is
    // not 1 and n mod 10 in 0..1 or n mod 10 in 5..9 or n mod 100 in 12..14"},
    //        {"ps", "one: n is 1"},
    //        {"pt", "one: n is 1"},
    //        {"ro", "one: n is 1;  few: n is 0 or n is not 1 and n mod 100 in 1..19"},
    //        {"ru", "one: n mod 10 is 1 and n mod 100 is not 11;  few: n mod 10 in 2..4 and n mod
    // 100 not in 12..14;  many: n mod 10 is 0 or n mod 10 in 5..9 or n mod 100 in 11..14"},
    //        {"si", "other: null"},
    //        {"sk", "one: n is 1;  few: n in 2..4"},
    //        {"sl", "one: n mod 100 is 1;  two: n mod 100 is 2;  few: n mod 100 in 3..4"},
    //        {"sq", "one: n is 1"},
    //        {"sr", "one: n mod 10 is 1 and n mod 100 is not 11;  few: n mod 10 in 2..4 and n mod
    // 100 not in 12..14;  many: n mod 10 is 0 or n mod 10 in 5..9 or n mod 100 in 11..14"},
    //        {"sv", "one: n is 1"},
    //        {"sw", "one: n is 1"},
    //        {"ta", "one: n is 1"},
    ...
    //        {"th", "other: null"},
    //        {"tr", "other: null"},
    //        {"uk", "one: n mod 10 is 1 and n mod 100 is not 11;  few: n mod 10 in 2..4 and n mod
    // 100 not in 12..14;  many: n mod 10 is 0 or n mod 10 in 5..9 or n mod 100 in 11..14"},
    //        {"ur", "one: n is 1"},
    //        {"uz", "other: null"},
    //        {"vi", "other: null"},
    ...
    //        { "is", "one: j mod 10 is 1 and j mod 100 is not 11 or f mod 10 is 1 and f mod 100 is
    // not 11" },
    //        { "fil,tl", "one: j in 0..1" },
    //        { "he,iw", "one: j is 1;  two: j is 2; many: j not in 0..10 and j mod 10 is 0",
    // "10,20" },
    //        { "hi", "one: n within 0..1" },
    //        { "hy", "one: n within 0..2 and n is not 2" },
    //        //                    {"hr", "one: j mod 10 is 1 and j mod 100 is not 11;  few: j mod
    // 10 in 2..4 and j mod 100 not in 12..14;  many: j mod 10 is 0 or j mod 10 in 5..9 or j mod 100
    // in 11..14"},
    ...
    //        //                            "one: n mod 10 is 1 and n mod 100 is not 11" +
    //        //                            " or v in 1..6 and f mod 10 is 1 and f mod 100 is not
    // 11" +
    //        //                            " or v not in 0..6 and f mod 10 is 1"},
    //        {
    //            "pl",
    //        "one: j is 1;  few: j mod 10 in 2..4 and j mod 100 not in 12..14;  many: j is not 1
    // and j mod 10 in 0..1 or j mod 10 in 5..9 or j mod 100 in 12..14" },
    //        { "sl", "one: j mod 100 is 1;  two: j mod 100 is 2;  few: j mod 100 in 3..4 or v is
    // not 0" },
    ...
    //        //                            " or v in 1..6 and f mod 10 in 2..4 and f mod 100 not in
    // 12..14" +
    ...
    //        { "mo,ro", "one: j is 1; few: v is not 0 or n is 0 or n is not 1 and n mod 100 in
    // 1..19" },
    //        { "ru", "one: j mod 10 is 1 and j mod 100 is not 11;" +
    //            " many: j mod 10 is 0 or j mod 10 in 5..9 or j mod 100 in 11..14"
    //            //                            + "; many: j mod 10 is 0 or j mod 10 in 5..9 or j
    // mod 100 in 11..14"
    //        },
