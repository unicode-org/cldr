...
/**
 * Constants specific to CLDR tools. Not to be used with the Survey Tool. Moved
 * here from
 * CldrUtilities
 *
 * @author srl
...
public class ToolConstants {
        ...
        public static final List<String> CLDR_VERSIONS = ImmutableList.of(
                        ...
                        "42.0", "43.0", "44.0", "44.1", "45.0", "46.0", "46.1", "47.0", "48.0", "48.1", "48.2"
        // add to this once the release is final!
        );
        public static final Set<VersionInfo> CLDR_VERSIONS_VI = ImmutableSet.copyOf(
                        CLDR_VERSIONS.stream()
                                        .map(x -> VersionInfo.getInstance(x))
                                        .collect(Collectors.toList()));

        public static final String DEV_VERSION = "48";
        ...
        public static final Set<String> CLDR_RELEASE_AND_DEV_VERSION_SET = ImmutableSet.<String>builder()
        ...
        public static final VersionInfo CHART_VI = VersionInfo
                        .getInstance(CldrUtility.getProperty("CHART_VERSION", DEV_VERSION));
        public static final String CHART_VERSION = CHART_VI.getVersionString(1, 2);

        public static final String PREV_CHART_VERSION_RAW = CldrUtility.getProperty("PREV_CHART_VERSION",
                        previousVersion(CHART_VERSION));
        ...
        public static final String PREV_CHART_VERSION_WITH0 = PREV_CHART_VI.getVersionString(2, 2); // must have 1
                                                                                                    // decimal

        public static final ChartStatus CHART_STATUS = ChartStatus.valueOf(
        ...
        public static final String LAST_RELEASE_VERSION_WITH0 = LAST_RELEASE_VI.getVersionString(2, 2); // must have 1
                                                                                                        // decimal
