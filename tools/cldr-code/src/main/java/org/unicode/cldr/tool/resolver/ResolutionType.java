...
public enum ResolutionType {
    ...
    private static final List<String> SIMPLE_INHERITANCE =
            Arrays.asList(
                    new String[] {
                        "s", "simple", "simpleinheritance", "simple-inheritance", "p", "partial"
                    });

    /** A list of resolve types that will result in the fully-resolved inheritance model */
    private static final List<String> FULLY_RESOLVED =
            Arrays.asList(new String[] {"f", "full", "fully", "fullyresolved", "fully-resolved"});

    /**
     * A list of resolve types that will result in the fully-resolved inheritance model with
     * code-fallback suppressed
     */
    private static final List<String> FULLY_RESOLVED_WITHOUT_CODE_FALLBACK =
            Arrays.asList(
                    new String[] {
                        "n", "nc", "nocode", "no-code", "nocodefallback", "no-code-fallback"
                    });
     ...
     * @throws IllegalArgumentException if str does not correspond to any known resolution type
    ...
    public static ResolutionType forString(String str) {
        ...
        if (SIMPLE_INHERITANCE.contains(str)) {
            ...
            throw new IllegalArgumentException(
                    "\"" + str + "\" is not a known type of resolution.");
        }
    }
}
