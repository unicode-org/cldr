...
/**
 * Constant paths (moved here from CldrUtility). These must not be used by any code destined for the
 * SurveyTool, as this class will not be included.
 *
 * @author srl
 *     <p>TODO: clarify "this class will not be included" comment above. Why is it necessary and/or
 *     preferable not to include this class in ST? Anyway, note that
 *     CLDRConfig.getInstance().getCldrBaseDirectory() can be used as an alternative to
...
public class CLDRPaths {
    ...
    public static final String CASING_DIRECTORY =
            CldrUtility.getPath(COMMON_DIRECTORY, CASING_SUBDIR);
    public static final String MAIN_DIRECTORY =
            CldrUtility.getProperty(
                    "CLDR_MAIN", CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, MAIN_SUBDIR));

    public static final String RBNF_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, RBNF_SUBDIR);
    public static final String TRANSFORMS_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, TRANSFORMS_SUBDIR);
    public static final String ANNOTATIONS_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, ANNOTATIONS_SUBDIR);
    public static final String SUBDIVISIONS_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, SUBDIVISIONS_SUBDIR);
    public static final String ANNOTATIONS_DERIVED_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, ANNOTATIONS_DERIVED_SUBDIR);
    public static final String VALIDITY_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, VALIDITY_SUBDIR);

    public static final String STAGING_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.BASE_DIRECTORY, "../cldr-staging/");

    public static final String TEST_DATA = COMMON_DIRECTORY + "testData/";

    public static final String SEED_DIRECTORY1 =
            CldrUtility.getProperty(
                    "CLDR_SEED", CldrUtility.getPath(CLDRPaths.COMMON_DIRECTORY, "../" + "seed/"));
    public static final String SEED_DIRECTORY = CldrUtility.getPath(SEED_DIRECTORY1, MAIN_SUBDIR);
    public static final String SEED_COLLATION_DIRECTORY =
            CldrUtility.getPath(SEED_DIRECTORY1, COLLATION_SUBDIR);
    public static final String SEED_CASING_DIRECTORY =
            CldrUtility.getPath(SEED_DIRECTORY1, CASING_SUBDIR);
    public static final String SEED_ANNOTATIONS_DIRECTORY =
            CldrUtility.getPath(SEED_DIRECTORY1, ANNOTATIONS_SUBDIR);
    ...
    public static final String UNITTEST_DATA_DIR =
            CldrUtility.getPath(
                    BASE_DIRECTORY,
                    "tools/cldr-code/src/test/resources/org/unicode/cldr/unittest/data");

    public static final String CHART_DIRECTORY =
            CldrUtility.getPath(STAGING_DIRECTORY + "docs/charts/", ToolConstants.CHART_VERSION);
    ...
    public static final String AUX_DIRECTORY =
            CldrUtility.getPath(CldrUtility.getProperty("CLDR_TMP_DIR", "cldr-aux/"));

    /** Local files, not backed up on either Github or SVN * */
    public static final String LOCAL_DIRECTORY =
            CldrUtility.getPath(CldrUtility.getProperty("LOCAL_DIR", BASE_DIRECTORY + "/../"));

    public static final String ARCHIVE_DIRECTORY =
            CldrUtility.getPath(
                    CldrUtility.getProperty(
                            "ARCHIVE", CldrUtility.getPath(LOCAL_DIRECTORY, "cldr-archive/")));
    public static final String LAST_RELEASE_DIRECTORY =
            ARCHIVE_DIRECTORY + "cldr-" + ToolConstants.LAST_RELEASE_VERSION_WITH0 + "/";
    public static final String LAST_COMMON_DIRECTORY =
            CldrUtility.getPath(LAST_RELEASE_DIRECTORY, "common/");
    public static final String LAST_TRANSFORMS_DIRECTORY =
            CldrUtility.getPath(CLDRPaths.LAST_COMMON_DIRECTORY, TRANSFORMS_SUBDIR);
    ...
    public static final String DATA_DIRECTORY =
            CldrUtility.getPath(
                    CldrUtility.getProperty(
                            "CLDR_EXT_DATA_DIR", CldrUtility.getPath(LOCAL_DIRECTORY, "Data/")));

    // probably can be removed & replaced
    public static final String CLDR_PRIVATE_DIRECTORY =
            CldrUtility.getPath(
                    CldrUtility.getProperty(
                            "CLDR_PRIVATE_DATA",
    ...
    public static final String TMP_DIRECTORY =
            CldrUtility.getPath(
                    CldrUtility.getProperty(
                            "CLDR_TMP_DIR", CldrUtility.getPath(LOCAL_DIRECTORY, "../cldr-tmp/")));
    public static final String TMP2_DIRECTORY =
            CldrUtility.getPath(
                    CldrUtility.getProperty(
                            "CLDR_TMP_DIR", CldrUtility.getPath(LOCAL_DIRECTORY, "../cldr-tmp2/")));
    ...
    public static final String UTIL_DATA_DIR =
            FileReaders.getRelativeFileName(CldrUtility.class, "data/");
