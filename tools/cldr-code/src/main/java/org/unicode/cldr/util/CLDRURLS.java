...
public abstract class CLDRURLS {
     ...
     */
    public static final String CLDR_REPO_BASE =
        "https://github.com/unicode-org/cldr";
    public static final String DEFAULT_COMMIT_BASE =
        CLDR_REPO_BASE + "/commit/";
    /**
    ...
    public static final String DEFAULT_BASE =
        "https://" + DEFAULT_HOST + DEFAULT_PATH;
    /**
    ...
    public static final String CLDR_REPO_ROOT =
        "https://github.com/unicode-org/cldr";
    ...
    public static final String CLDR_UPDATINGDTD_URL =
        CLDR_HOMEPAGE + "/development/updating-dtds";
    /**
     ...
     */
    public static final String UNICODE_SPDX_HEADER =
        "SPDX-License-Identifier: " + UNICODE_SPDX;
    /**
    ...
    public static final String GENERAL_HELP_URL =
    ...
    public static final String CHARACTERS_HELP =
        "https://cldr.unicode.org/translation/characters";
    public static final String CHARACTER_LABELS =
        "https://cldr.unicode.org/translation/characters/character-labels";
    public static final String CHARTS_URL =
        "https://cldr.unicode.org/index/charts#TOC-Summary";
    ...
    public static final String TRANSFORMS_HELP =
        "https://cldr.unicode.org/translation/transforms";
    ...
    public static final String UNITS_HELP =
        "https://cldr.unicode.org/translation/units";
    /*
     ...
     * @return
     */
    public final String forXpathHexId(
        String locale,
     ...
     */
    public final void assertIsHexId(String hexid)
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException
     */
    public final void assertIsXpath(String xpath)
        throws IllegalArgumentException {
     ...
     * @return
     */
    public final String forPathHeader(
        CLDRLocale locale,
    ...
    public static String gitHashToLink(String hash) {
        if (!isKnownHash(hash)) return (
            "<span class=\"githashLink\">" + hash + "</span>"
        ); // Not linkifiable
        return (
