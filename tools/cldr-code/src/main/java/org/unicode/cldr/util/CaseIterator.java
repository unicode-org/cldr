...
public class CaseIterator {
    ...
    private static Transliterator toHex2 =
            Transliterator.getInstance("[[^\u0021-\u007F]-[,]] Any-Hex");
    ...
    private static String[][] exceptionList = {
        ...
        // ffi
        {
            "ffi", "FFI", "FFi", "FfI", "Ffi", "F\uFB01", "fFI", "fFi", "ffI", "ffi", "f\uFB01",
            "\uFB00I", "\uFB00i",
        },
        // ffl
        {
            "ffl", "FFL", "FFl", "FfL", "Ffl", "F\uFB02", "fFL", "fFl", "ffL", "ffl", "f\uFB02",
            "\uFB00L", "\uFB00l",
        },
        // fi
        {
