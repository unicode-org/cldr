...
public class CoverageInfo {
    ...
    private Cache<String, CoverageLevel2> localeToCoverageLevelInfo =
            CacheBuilder.newBuilder().maximumSize(MAXLOCALES).build();
    private Cache<XPathWithLocation, Level> coverageCache =
            CacheBuilder.newBuilder().maximumSize(MAXLOCALES).build();
