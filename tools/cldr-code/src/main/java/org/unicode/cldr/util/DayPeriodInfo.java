...
public class DayPeriodInfo {
    ...
    public static class Builder {
        ...
        public DayPeriodInfo.Builder add(
            ...
            if (dayPeriod == null || start < 0 || start > end || end > DAY_LIMIT || end - start > NOON) { // the span can't exceed 12 hours
    ...
    public boolean collisionIsError(
        ...
        if (
            (allowableCollisions.containsKey(dayPeriod1) && allowableCollisions.get(dayPeriod1).contains(dayPeriod2)) ||
