...
/**
 * This is a first-cut version just to get going. The data is hard coded until we switch over to
 * real data in ICU.
 */
public class DayPeriods {
    ...
    /**
     * Get a sample, for showing to a localizer. The actual phrase should come out of a SELECT
     * statement, since it may vary by message.
     *
     * @param millisInDay
     * @return
     */
    ...
    /**
     * Get an instance with a factory method. Right now, returns null if the locale data is not
     * available.
     *
     * @param loc
     * @return
    ...
    /**
     * Returns the available locales. Note that regional/script variants may be mapped by
     * getInstance to a base locale, eg, en-AU => en.
     *
     * @return
     */
