...
public class DtdDataCheck {
                    ...
                    if (!allDeprecated) {
                        ...
                        if (info == null) {
                            TYPE_ATTRIBUTE_TO_DIST_ELEMENTS.put(
                                    key, info = Relation.of(new TreeMap<Boolean, Set<String>>(), TreeSet.class));
                        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String arg : args) {
            ...
            PrintWriter br =
                    FileUtilities.openUTF8Writer(CLDRPaths.GEN_DIRECTORY + "dataproj/src/temp/", type + "-gen.dtd");
            ...
            if (CHECK_CORRECTNESS && type == DtdType.ldml) {
                ...
                // {
                //                        Comparator<String> comp = CLDRFile.getAttributeValueComparator(element,
                // attribute);
