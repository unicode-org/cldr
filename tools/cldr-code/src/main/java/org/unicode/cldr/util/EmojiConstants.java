...
public class EmojiConstants {
    ...
    public static final UnicodeSet MODIFIERS = new UnicodeSet(0x1F3FB, 0x1F3FF)
        .freeze();
    public static final UnicodeSet HAIR = new UnicodeSet(0x1F9B0, 0x1F9B3)
        .freeze();
    public static final char JOINER = '\u200D';
    public static final String JOINER_STRING = String.valueOf(JOINER);
    public static final UnicodeSet COMPONENTS = new UnicodeSet(
        EmojiConstants.MODIFIERS
    )
    ...
    public static final String COMPOSED_HANDSHAKE = new String(
        new int[] { 0x1FAF1, 0x200D, 0x1FAF2 },
        0,
        3
    );
    ...
    public static final UnicodeSet HAIR_EXPLICIT = new UnicodeSet("[🧔 👱]")
        .freeze();

    public static final ListTypeLength COMPOSED_NAME_LIST =
        ListTypeLength.UNIT_SHORT;
    ...
    public static String getFlagCode(String s) {
        return (
            String.valueOf((char) (s.codePointAt(0) - FIRST_REGIONAL + 'A')) +
            (char) (s.codePointAt(2) - FIRST_REGIONAL + 'A')
        );
    }
    ...
    public static final UnicodeSet REM_SKIP_SET = new UnicodeSet()
        .add(JOINER_STRING)
        .freeze();
    public static final UnicodeSet REM_GROUP_SKIP_SET = new UnicodeSet(
        REM_SKIP_SET
    )
    ...
    public static CharSequence fromCodePoints(int... codePoints) {
        return EmojiConstants
            .appendCodePoints(new StringBuilder(), codePoints)
            .toString();
    }

    public static StringBuilder appendCodePoints(
        StringBuilder b,
        int... codePoints
    ) {
