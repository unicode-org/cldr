...
public class FileCopier {
    ...
    public static void copy(
        ...
        try (
            ...
            Writer wr = new FileWriter(
                Paths.get(targetDirectory, newName).toFile()
            );
        ) {
     ...
     * @throws IOException
     */
    public static void copy(Class<?> cls, String sourceFile, Writer out)
        throws IOException {
        copy(
            new InputStreamReader(
                cls.getResourceAsStream(sourceFile),
    ...
    public static void copy(
        ...
        copy(
            new InputStreamReader(cls.getResourceAsStream(sourceFile), charset),
            out
        );
    }
