...
public class FileCopier {
    ...
    public static void copyAndReplace(
            Class<?> cls, String srcFile, Charset charSet, Map<String, String> replacements, Writer out)
            throws IOException {
    ...
    public static void copyAndReplace(
            Class<?> cls, String srcFile, String destDir, String destFile, Map<String, String> replacements)
            throws IOException {
        copyAndReplace(
