...
public class GrammarDerivation implements Freezable<GrammarDerivation> {
    ...
    public class Values {
        ...
        public String toString() {
            final ToStringHelper temp = MoreObjects
    ...
    public void add(String featureStr, String structureStr, String... values) {
        ...
        CompoundUnitStructure structure = CompoundUnitStructure.valueOf(
            structureStr
        );
        Map<CompoundUnitStructure, Values> structureToValues = data.get(
            feature
        );
    ...
    public Values get(
        ...
        CompoundUnitStructure structure
    ) {
        Map<CompoundUnitStructure, Values> structureToValues = data.get(
            feature
        );
