...
public class GrammarInfo implements Freezable<GrammarInfo> {
    ...
    public enum GrammaticalFeature {
        ...
        static final Map<String, GrammaticalFeature> shortNameToEnum =
                ImmutableMap.copyOf(Arrays.asList(GrammaticalFeature.values()).stream().collect(Collectors.toMap(e -> e.shortName, e -> e)));
    ...
    public static final Set<String> SEED_LOCALES =
            ImmutableSet.of("pl", "ru", "da", "de", "nb", "sv", "hi", "id", "es", "fr", "it", "nl", "pt", "en", "ja", "th", "vi", "zh", "zh_TW", "ko", "yue");
    ...
    public void getSourceCaseAndPlural(
            String locale, String gender, String value, String desiredCase, String desiredPlural, Output<String> sourceCase, Output<String> sourcePlural) {
        switch (locale) {
            case "pl":
    ...
    private void getSourceCaseAndPluralRussian(
            String gender, String value, String desiredCase, String desiredPlural, Output<String> sourceCase, Output<String> sourcePlural) {
