...
public class ICUServiceBuilder {
    ...
    private String getDateTimePattern(String calendar, String dateOrTime, String type) {
        ...
        if (value == null) throw new IllegalArgumentException(
            "locale: " + cldrFile.getLocaleID() + "\tpath: " + key + CldrUtility.LINE_SEPARATOR + "value: " + value
        );
        return value;
    }
    ...
    private String getSymbolString(String key, String numsys) {
        ...
        try {
            value =
                cldrFile.getWinningValueWithBailey("//ldml/numbers/symbols[@numberSystem=\"" + numsys + "\"]/" + key);
            ...
            throw new IllegalArgumentException(
                "Illegal value <" + value + "> at " + "//ldml/numbers/symbols[@numberSystem='" + numsys + "']/" + key
            );
        }
    }
    ...
    private String getPattern(String key1, int isCurrency) {
        ...
        String type = key1;
        if (isCurrency == CURRENCY) type = "currency"; else if (key1.equals("integer")) type = "decimal";
        String path =
            prefix +
            type +
            "Formats/" +
