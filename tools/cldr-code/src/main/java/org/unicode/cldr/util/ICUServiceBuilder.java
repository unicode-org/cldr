...
public class ICUServiceBuilder {
        ...
        if (result == null) {
            ...
            if (locale != null) {
                ...
                result.collationFile =
                        Factory.make(CLDRPaths.COLLATION_DIRECTORY, ".*").makeWithFallback(locale.getBaseName());
            }
    ...
    private RuleBasedCollator _getRuleBasedCollator(String type) throws Exception {
        ...
        if (collationFile.isHere(importPath)) {
            ...
            CLDRFile importCollationFile =
                    Factory.make(CLDRPaths.COLLATION_DIRECTORY, ".*").makeWithFallback(importLocale.getBaseName());
    ...
    private DateFormatSymbols _getDateFormatSymbols(String calendar) {
        ...
        formatData.setMonths(
                getArray(prefix, "month", "format", "wide"), DateFormatSymbols.FORMAT, DateFormatSymbols.WIDE);
        formatData.setMonths(
                getArray(prefix, "month", "format", "abbreviated"),
                DateFormatSymbols.FORMAT,
                DateFormatSymbols.ABBREVIATED);
        formatData.setMonths(
                getArray(prefix, "month", "format", "narrow"), DateFormatSymbols.FORMAT, DateFormatSymbols.NARROW);

        formatData.setMonths(
                getArray(prefix, "month", "stand-alone", "wide"), DateFormatSymbols.STANDALONE, DateFormatSymbols.WIDE);
        formatData.setMonths(
        ...
        formatData.setWeekdays(
                getArray(prefix, "day", "format", "wide"), DateFormatSymbols.FORMAT, DateFormatSymbols.WIDE);
        formatData.setWeekdays(
                getArray(prefix, "day", "format", "abbreviated"),
                DateFormatSymbols.FORMAT,
                DateFormatSymbols.ABBREVIATED);
        formatData.setWeekdays(
                getArray(prefix, "day", "format", "narrow"), DateFormatSymbols.FORMAT, DateFormatSymbols.NARROW);

        formatData.setWeekdays(
                getArray(prefix, "day", "stand-alone", "wide"), DateFormatSymbols.STANDALONE, DateFormatSymbols.WIDE);
        formatData.setWeekdays(
        ...
        formatData.setQuarters(
                getArray(prefix, "quarter", "format", "wide"), DateFormatSymbols.FORMAT, DateFormatSymbols.WIDE);
        formatData.setQuarters(
                getArray(prefix, "quarter", "format", "abbreviated"),
                DateFormatSymbols.FORMAT,
                DateFormatSymbols.ABBREVIATED);
        formatData.setQuarters(
                getArray(prefix, "quarter", "format", "narrow"), DateFormatSymbols.FORMAT, DateFormatSymbols.NARROW);
    ...
    private DecimalFormat _getNumberFormat(String key1, int kind, String currencySymbol, String numberSystem) {
        String localeIDString =
                (numberSystem == null) ? cldrFile.getLocaleID() : cldrFile.getLocaleID() + "@numbers=" + numberSystem;
        ...
        if (kind == CURRENCY) {
            ...
            mc = new MyCurrency(key1, currencySymbol, cldrFile.getWinningValueWithBailey(prefix + "displayName"), info);
    ...
    private String fixCurrencySpacing(String pattern, String symbol) {
        ...
        if (endPos < pattern.length() && afterCurrencyMatch.contains(UTF16.charAt(symbol, symbol.length() - 1))) {
    ...
    private DecimalFormatSymbols _getDecimalFormatSymbols(String numberSystem) {
        ...
        beforeSurroundingMatch =
                new UnicodeSet(cldrFile.getWinningValueWithBailey(prefix + "surroundingMatch")).freeze();
