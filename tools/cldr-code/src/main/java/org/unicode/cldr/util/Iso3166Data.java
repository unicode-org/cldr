...
public class Iso3166Data {
    ...
    private static final class Iso3166Helper {
        ...
        public Iso3166Helper() {
            ...
            for (String line : FileUtilities.in(Iso3166Data.class, "data/external/iso_3166_status.txt")) {
    ...
    private static final List<String> DELETED3166 = Collections.unmodifiableList(Arrays
    ...
    final private static Set<String> REGION_CODES_NOT_FOR_TRANSLATION = Collections.unmodifiableSet(Collections.singleton("CQ"));

    /**
     * Exceptionally reserved ISO-3166-1 region code, but
     * should not be translated at present.
     */
