...
public enum LanguageGroup {
    ...
    static final M3<LanguageGroup, ULocale, Integer> GROUP_LANGUAGE =
            ChainedMap.of(new TreeMap<LanguageGroup, Object>(), new LinkedHashMap<ULocale, Object>(), Integer.class);
    ...
    static {
        ...
        add(temp, root, "root");
        add(temp, germanic, "en", "fy", "nl", "af", "de", "gsw", "wae", "ksh", "lb", "sv", "da", "nb", "nn", "fo", "is", "yi", "nds");
        add(temp, celtic, "ga", "gd", "cy", "gv", "kw", "br");
        add(temp, romance, "fr", "pt", "gl", "es", "ca", "ast", "it", "rm", "ro", "fur", "an", "co", "oc", "sc", "scn", "wa");
        add(temp, slavic, "pl", "cs", "sk", "sl", "hr", "bs", "mk", "sr", "bg", "ru", "be", "uk", "dsb", "hsb", "cu", "szl");
        add(temp, baltic, "lt", "lv", "prg");
        add(temp, indic, "ur", "hi", "gu", "sd", "bn", "as", "ccp", "or", "mr", "ne", "pa", "si", "kok", "ks", "mai", "doi", "dv", "sa", "trw");
        ...
        add(temp, austronesian, "id", "ms", "jv", "fil", "haw", "mg", "to", "ceb", "mi", "su", "trv");
        ...
        add(
                ...
                "ny",
                "st");
        add(temp, american, "chr", "kl", "lkt", "qu", "arn", "cad", "cic", "gn", "iu", "moh", "mus", "nv", "osa", "quc", "nci");
    ...
    public static void main(String[] args) {
        ...
        for (LanguageGroup languageGroup : LanguageGroup.values()) {
            ...
            System.out.print(
                    "\t\t<languageGroup id=\"" + languageGroup.iso + "\" code=\"" + Joiner.on(", ").join(locales) + "\"/>\t<!-- " + englishName + " -->\n");
        }
