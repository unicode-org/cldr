...
public enum LanguageGroup {
    ...
    private static void add(
            Map<ULocale, LanguageGroup> map, LanguageGroup group, String... baseLanguages) {
    ...
    static {
        ...
        add(temp, root, "root");
        add(
                temp, germanic, "en", "fy", "nl", "af", "de", "gsw", "wae", "ksh", "lb", "sv", "da",
                "no", "nb", "nn", "fo", "is", "yi", "nds");
        add(temp, celtic, "ga", "gd", "cy", "gv", "kw", "br");
        add(
                temp, romance, "fr", "pt", "gl", "es", "ca", "ast", "it", "rm", "ro", "fur", "an",
                "co", "oc", "sc", "scn", "wa");
        add(
                temp, slavic, "pl", "cs", "sk", "sl", "hr", "bs", "mk", "sr", "bg", "ru", "be",
                "uk", "dsb", "hsb", "cu", "szl");
        add(temp, baltic, "lt", "lv", "prg");
        add(
                temp, indic, "ur", "hi", "gu", "sd", "bn", "as", "ccp", "or", "mr", "ne", "pa",
                "si", "kok", "ks", "mai", "doi", "dv", "sa", "trw");
        ...
        add(
                ...
                "st");
        add(
                temp, american, "chr", "kl", "lkt", "qu", "arn", "cad", "cic", "gn", "iu", "moh",
                "mus", "nv", "osa", "quc", "nci");
    ...
    public static LanguageGroup get(ULocale locale) {
        return CldrUtility.ifNull(
                LANGUAGE_GROUP.get(new ULocale(locale.getLanguage())), LanguageGroup.other);
    }
