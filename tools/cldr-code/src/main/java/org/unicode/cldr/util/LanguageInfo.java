...
public class LanguageInfo {
    ...
    // private M3<OfficialStatus, String, Boolean> status = ChainedMap.of(new EnumMap<OfficialStatus, Object>(OfficialStatus.class), new
    // TreeMap<String,Object>(), Boolean.class);
