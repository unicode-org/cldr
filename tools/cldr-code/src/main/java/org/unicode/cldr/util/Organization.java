...
public enum Organization {
    ...
    adlam("Winden Jangen Adlam"), adobe("Adobe"), afghan_csa("Afghan CSA"), afghan_mcit("Afghan MCIT"), afrigen("Afrigen"), apple("Apple"), bangladesh(
        "Bangladesh", "Bangladesh Computer Council"), bangor_univ("Bangor Univ."), bhutan("Bhutan DDC"), breton("Office of Breton Lang"), cherokee(
            "Cherokee Nation"), cldr("Cldr"), facebook("Facebook"), gaeilge("Foras na Gaeilge"), georgia_isi("Georgia ISI"), gnome("Gnome Foundation"), google(
                "Google"), guest("Guest (Unicode)"), ibm("IBM"), india("India MIT"), iran_hci("Iran HCI"), kendra("Kendra (Nepal)"), kotoistus(
                    "Kotoistus (Finnish IT Ctr)"), kunsill_malti("Il-Kunsill Nazzjonali tal-Ilsien Malti", "National Council for the Maltese Language", "malta",
                        "malti"), lakota_lc("Lakota LC"), lao_dpt("Lao Posts/Telecom??"), longnow("The Long Now Foundation", "Long Now", "PanLex",
                            "Utilka Foundation"), microsoft("Microsoft"), mozilla("Mozilla"), netflix("Netflix"), openinstitute(
                                "Open Inst (Cambodia)"), openoffice_org("Open Office"), oracle("Oracle", "sun", "Sun Micro"), pakistan("Pakistan"), rodakych(
                                    "Rodakych", "Nigerian Pidgin"), rumantscha("Lia Rumantscha"), sil("SIL", "SIL International"), srilanka("Sri Lanka ICTA",
