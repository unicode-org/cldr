    ...
    private boolean checkAttribute(
        ...
        if (elementToAttrToAttrValueToStatus == null) {
            Map<String, Map<String, Map<String, ValueStatus>>> subAlready =
                    seenEAV.putIfAbsent(dtdData.dtdType, elementToAttrToAttrValueToStatus = new ConcurrentHashMap<>());
            if (subAlready != null) {
        ...
        if (attrValueToStatus == null) {
            Map<String, ValueStatus> setAlready =
                    attrToAttrValueToStatus.putIfAbsent(attribute, attrValueToStatus = new ConcurrentHashMap<>());
            if (setAlready != null) {
