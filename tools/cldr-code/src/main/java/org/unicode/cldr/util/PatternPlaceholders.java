...
public class PatternPlaceholders {
    ...
    public static final ImmutableSet<Subtype> PLACEHOLDER_SUBTYPES =
            ImmutableSet.of(Subtype.gapsInPlaceholderNumbers, Subtype.duplicatePlaceholders, Subtype.missingPlaceholders, Subtype.extraPlaceholders);
    ...
    private PatternPlaceholders() {
        patternPlaceholders =
                RegexLookup.of(new MapTransform()).setValueMerger(new MyMerger()).loadFromFile(PatternPlaceholders.class, "data/Placeholders.txt");
    }
