...
public class PatternPlaceholders {
    ...
    public enum PlaceholderStatus {
        ...
        OPTIONAL(
                "Any specific placeholder is optional (and non-numeric); there must be at least one.") //
    ;
                ...
                for (String part : parts) {
                    switch (part) {
                        ...
                        default:
                            ...
                            // Hack for now, later do something maybe using
                            // PersonNameFormatter.ModifiedField
