...
public class PluralSamples {
  ...
  public PluralSamples(String locale) {
    ...
    samples[0] =
      Collections.unmodifiableMap(getValuesForDigits(pluralInfo, total, 0, 9));
    samples[1] =
      Collections.unmodifiableMap(
        getValuesForDigits(pluralInfo, total, 10, 99)
      );
    samples[2] =
      Collections.unmodifiableMap(
        getValuesForDigits(pluralInfo, total, 100, 999)
      );
    samples[3] =
      Collections.unmodifiableMap(
        getValuesForDigits(pluralInfo, total, 1000, 9999)
      );
  }
