...
public final class PreferredAndAllowedHour
    ...
    private static final Comparator<PreferredAndAllowedHour> COMPARATOR = Comparator
        .<PreferredAndAllowedHour, HourStyle>comparing(t -> t.preferred)
        .thenComparing(
            t -> t.allowed,
            lexicographical(Comparator.<HourStyle>naturalOrder())
        );
    ...
    private PreferredAndAllowedHour(
        String preferredStyle,
        Stream<String> allowedStyles
    ) {
        this.preferred = checkNotNull(HourStyle.valueOf(preferredStyle));
        this.allowed =
            allowedStyles.map(HourStyle::valueOf).collect(toImmutableList());
        checkArgument(
    ...
    public boolean equals(Object obj) {
        return (
            obj instanceof PreferredAndAllowedHour &&
