...
public final class PreferredAndAllowedHour implements Comparable<PreferredAndAllowedHour> {
    ...
    private PreferredAndAllowedHour(String preferredStyle, Stream<String> allowedStyles) {
        ...
        checkArgument(
                allowed.stream().distinct().count() == allowed.size(),
                "Allowed (%s) must not contain duplicates",
                allowed);
        ...
        checkArgument(
                ...
                "Allowed (%s) must contain preferred (%s)",
                allowed,
                preferred);
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof PreferredAndAllowedHour
                && compareTo((PreferredAndAllowedHour) obj) == 0;
    }
}
