 ...
 * called.
 *
 * <p>The first intended usage is for TestExampleDependencies, to identify all the paths on which a
 * given example depends. Before calling ExampleGenerator.getExampleHtml, TestExampleDependencies
 * calls clearRecordedPaths. After getting each example, TestExampleDependencies calls
 * getRecordedPaths to get the set of all paths in this file that were accessed to generate the
 * example.
 */
