...
/**
 * Parses a file of regexes for use in RegexLookup or any other class that requires a list of
 * regexes.
 *
 * @author jchye
 */
public class RegexFileParser {
    ...
    /** Stores variables given to it by the RegexFileParser and performs replacements if needed. */
    ...
    private static final VariableProcessor DEFAULT_VARIABLE_PROCESSOR =
                ...
                if (line.charAt(0) == '%') {
                    ...
                    if (pos < 0) {
                        throw new IllegalArgumentException(
                                "Failed to read variable in " + source + "\t\t(" + lineNumber + ") " + line);
                    }
