...
public class SimpleFactory extends Factory {
    ...
    private static class SimpleFactoryCacheKey {
        ...
        public SimpleFactoryCacheKey(
                List<String> sourceDirectories, String matchString, DraftStatus mimimalDraftStatus) {
    ...
    public CLDRFile handleMake(String localeName, boolean resolved, DraftStatus minimalDraftStatus) {
        ...
        if (USE_OLD_HANDLEMAKE_CODE) {
            final Map<String, CLDRFile> cache =
                    resolved ? resolvedCache[minimalDraftStatus.ordinal()] : mainCache[minimalDraftStatus.ordinal()];
    ...
    public static CLDRFile makeFile(
            String fileName, String localeName, InputStream fis, CLDRFile.DraftStatus minimalDraftStatus) {
    ...
    public static CLDRFile makeFile(String localeName, String dir, boolean includeDraft) {
        return makeFile(
                localeName, dir, includeDraft ? CLDRFile.DraftStatus.unconfirmed : CLDRFile.DraftStatus.approved);
    }
