...
public class SimpleFactory extends Factory {
    ...
    private static class CLDRCacheKey {
        ...
        public CLDRCacheKey(
            ...
            hashCode =
                Objects.hash(this.localeName, this.resolved, this.draftStatus, this.directories);
        }
    ...
    private static class SimpleFactoryCacheKey {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((matchString == null) ? 0 : matchString.hashCode());
            result =
                prime * result + ((mimimalDraftStatus == null) ? 0 : mimimalDraftStatus.hashCode());
            result =
                prime * result + ((sourceDirectories == null) ? 0 : sourceDirectories.hashCode());
            return result;
        }
            ...
            if (fact == null) {
                ...
                while (iter.hasNext()) {
                    ...
                    if ((key2 != null) && factoryCache.asMap().containsKey(key2)) {
                        if (DEBUG_SIMPLEFACTORY) {
                            System.out.println(
                                "Using key " + key2 + " instead of " + key + " for factory lookup"
                            );
                        }
                        return factoryCache.asMap().get(key2);
                    }
