...
public class SimpleFactory extends Factory {
  ...
  private static class SimpleFactoryLookupKey {
    ...
    public int hashCode() {
      ...
      int result = 1;
      result =
        prime * result + ((directory == null) ? 0 : directory.hashCode());
      result =
        prime * result + ((matchString == null) ? 0 : matchString.hashCode());
      return result;
    }
  ...
  public static class NoSourceDirectoryException
    ...
    public String getMessage() {
      return (
        "Unable to determine the source directory for locale " + localeName
      );
    }
  }
  ...
  public CLDRFile handleMake(
    ...
    if (USE_OLD_HANDLEMAKE_CODE) {
      ...
      cacheKey =
        new CLDRCacheKey(localeName, resolved, minimalDraftStatus, parentDirs);
      //        result = cache.get(localeName);
        ...
        sourceDirectory =
          new File(
            sourceDirectory
              .getAbsolutePath()
              .replace(
                "incoming" + File.separator + "vetted" + File.separator,
