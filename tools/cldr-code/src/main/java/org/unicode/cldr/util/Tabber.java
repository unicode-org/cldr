...
public abstract class Tabber {
    ...
    public abstract void process_field(
            int count, String source, int start, int limit, StringBuffer output);
    ...
    public static class MonoTabber extends Tabber {
        ...
        public String toString() {
            ...
            for (int i = 0; i < stops.size(); ++i) {
                ...
                buffer.append(ALIGNMENT_NAMES[((Integer) types.get(i)).intValue()])
                        .append(",")
                        .append(stops.get(i));
            }
