...
public class TestStateDictionaryBuilder<T> {
    ...
    public static <U> void tryFind(
            CharSequence originalText, CharSource charListText, Dictionary<U> dictionary, Filter filter) {
        System.out.println(
                "Using dictionary: " + Dictionary.load(dictionary.getMapping(), new TreeMap<CharSequence, U>()));
    ...
    private void showDictionaryContents() {
        ...
        System.out.println(
                "Dictionary: " + Dictionary.load(stateDictionary.getMapping(), new TreeMap<CharSequence, T>()));
        System.out.println();
        if (SHOW_STATES) {
