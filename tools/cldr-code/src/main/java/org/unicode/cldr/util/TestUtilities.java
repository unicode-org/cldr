...
public class TestUtilities {
    ...
    private static void testNames() {
        ...
        String[] tests = {
            "en", "en_AU", "de_CH", "de_Arab_CH", "gsw", "gsw_Arab", "zh_Hans", "zh_Hans_US", "zh_Hans_US_SAAHO"
        };
    ...
    private static void testExampleGenerator() throws IOException {
        ...
        ExampleGenerator englishExampleGenerator =
                new ExampleGenerator(english, english, CLDRPaths.DEFAULT_SUPPLEMENTAL_DIRECTORY);
        // invoke once
