...
public class TestUtilities {
    ...
    private static void writeMetaData() throws IOException {
        ...
        meta.add(prefix + "valid/attributeValues[@order=\"given\"][@attributes=\"type\"][@elements=\"" + "day" + "\"]", String.join(" ", dayValueOrder));
        meta.add(
                prefix + "valid/attributeValues[@order=\"given\"][@attributes=\"" + "day" + "\"][@elements=\"" + "firstDay weekendEnd weekendStart" + "\"]",
        ...
        meta.add(
                prefix + "valid/attributeValues[@order=\"given\"][@attributes=\"type\"][@elements=\"" + String.join(" ", widths) + "\"]",
        ...
        meta.add(
                prefix + "valid/attributeValues[@order=\"given\"][@attributes=\"type\"][@elements=\"" + String.join(" ", formatLengths) + "\"]",
        ...
        meta.add(prefix + "valid/attributeValues[@order=\"given\"][@attributes=\"type\"][@elements=\"field\"]", String.join(" ", dateFieldOrder));
            ...
            for (int j = 0; j < zones.length; ++j) {
                ...
                for (int k = 0; k < fields.length; ++k) {
                    ...
                    for (int m = 1; m < fields[k].length; ++m) {
                        ...
                        out.println(
                                "{\"" + locale + "\",\t\"" + zone + "\",\t\"" + type + "\",\t\"" + field + "\",\t\"" + formatted + "\",\t\"" + parsed + "\"},");
                    }
                }
                out.println();
            }
