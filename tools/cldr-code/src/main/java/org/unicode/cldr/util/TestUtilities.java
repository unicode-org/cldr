...
public class TestUtilities {
    ...
    private static void checkTranslit() {
        ...
        for (UnicodeSetIterator it = new UnicodeSetIterator(a_out); it.next();) {
            ...
            out.println(
                com.ibm.icu.impl.Utility.hex(s, 4) + " (" + literal + ") " + UCharacter.getName(s)
            );
        }
    }
    ...
    private static void checkTranslit(String string) {
        ...
        if (!reverse.equals(string)) System.out.println(
            string + "\t=>\t" + html + "\t=>\t" + reverse + (!reverse.equals(string) ? " FAIL" : "")
        );
    ...
    private static void printZoneSamples() throws Exception {
        ...
        for (int i = 0; i < locales.length; ++i) {
            ...
            TimezoneFormatter tzf = new TimezoneFormatter(mainCldrFactory, locale, false)
                .setSkipDraft(true);
