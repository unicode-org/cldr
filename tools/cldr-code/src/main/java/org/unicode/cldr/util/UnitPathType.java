...
public enum UnitPathType {
    ...
    times(null, null, ImmutableMultimap.<String, String>builder().put("", "newton-meter").put("", "kilowatt-hour").build()),
    per(null, null, ImmutableMultimap.<String, String>builder().put("", "meter-per-second").put("", "mile-per-gallon").build()),
    prefix(
            null,
            null,
    ...
    public String getTranslationPath(
            LocaleStringProvider resolvedFile, String width, String shortUnitId, String pluralCategory, String caseVariant, String genderVariant) {
