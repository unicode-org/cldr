...
public enum UnitPathType {
    ...
    unit("kilometer", EnumSet.of(
        ...
        null), perUnit("minute", null, null), times(null, null, ImmutableMultimap.<String, String> builder()
            .put("", "newton-meter")
            .put("", "kilowatt-hour")
            .build()), per(null, null,
                        ...
                        ImmutableMultimap.<String, String> builder()
                            ...
                            .build()), power("power2",
                                ...
                                ImmutableMultimap.<String, String> builder()
                                    ...
                                    .build()), duration(null, null,
                                        null), gender(null, null, null), coordinate(null, null, null), displayName(null, null, null);
