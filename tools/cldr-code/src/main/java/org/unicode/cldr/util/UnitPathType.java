...
public enum UnitPathType {
  ...
  private UnitPathType(
    ...
    this.features =
      features == null ? Collections.emptySet() : ImmutableSet.copyOf(features);
  }
  ...
  public static UnitPathType getPathType(XPathParts parts) {
    ...
    switch (parts.getElement(-1)) {
      case "compoundUnitPattern":
        return "times".equals(parts.getAttributeValue(-2, "type"))
          ? UnitPathType.times
          : UnitPathType.per;
  ...
  public String getTranslationPath(
    ...
    final String pathPrefix =
      "//ldml/units/unitLength[@type=\"" + width + "\"]/";
    String longUnitId;
    GrammarInfo grammarInfo1;
    UnitConverter uc = CLDRConfig
      .getInstance()
    ...
    switch (pathType) {
      ...
      case power:
        ...
        grammarInfo1 =
          CLDRConfig
            .getInstance()
            .getSupplementalDataInfo()
            .getGrammarInfo(resolvedFile.getLocaleID());
      ...
      case coordinate:
        return (
          pathPrefix +
          "coordinateUnit/coordinateUnitPattern[@type=\"" +
          shortUnitId +
          "\"]"
        );
      case duration:
