...
public class ValuePathStatus {
    ...
    public static final UnicodeSet LATIN = new UnicodeSet("[:sc=Latn:]")
        .freeze();
    ...
    public static boolean isMissingOk(
        ...
        //        }
        ValuePathStatus.MissingOK value = missingOk.get(
            path,
            null,
            arguments,
            null,
        ...
        switch (value) {
            ...
            case compact:
                ...
                SupplementalDataInfo supplementalDataInfo2 = CLDRConfig
                    .getInstance()
                    .getSupplementalDataInfo();
                // SupplementalDataInfo.getInstance(sourceFile.getSupplementalDirectory());
                PluralInfo plurals = supplementalDataInfo2.getPlurals(
                    sourceFile.getLocaleID()
                );
