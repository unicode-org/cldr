        ...
        try {
            ...
            if (showCurrency) {
                tablePrinter1
                    ...
                    .setCellAttributes(
                        "class='dtf-s'"
                    )//                    .setCellAttributes("class='dtf-s'") //                    .setHeaderAttributes("class='dtf-th'") //                    .addColumn("Compact-Short<br>+Unit")
            ...
            try {
                for (double source : allSamples) {
                    ...
                    if (showCurrency) {
                        ...
                        )// .addCell(cdfsCurrLong.format(source)) //                             .addCell(cdfsCurr.format(source)) //                            .addCell(cdfU.format(source))
