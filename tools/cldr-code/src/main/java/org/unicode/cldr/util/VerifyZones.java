...
public class VerifyZones {
    ...
    private static final Map<String, Map<String, String>> metazoneToRegionToZone =
            sdi.getMetazoneToRegionToZone();
    ...
    static {
        ...
        for (String metazone : metazones) {
            ...
            //            MetazoneRow row = new MetazoneRow(order, offsetOrder, container, 0,
            // metazone, tz_string);
            //            rows.add(row);
        ...
        //            //            TimeZone currentZone = TimeZone.getTimeZone(tz_string);
        //            //            int offsetOrder = currentZone.getRawOffset();
        //            //            MetazoneRow row = new MetazoneRow(Integer.MAX_VALUE,
        // offsetOrder, "001", 1, "None", tz_string);
        //            //            rows.add(row);
        //            addRow("None", zone, 1);
        //        }
    ...
    private static void addRow(String metaZone, String tz_string, int orderInMetazone) {
        ...
        MetazoneRow row =
                new MetazoneRow(
                        order, offsetOrder, container, orderInMetazone, metaZone, tz_string);
    ...
    public static void main(String[] args) throws IOException {
        ...
        // CompactDecimalFormat cdf = BuildIcuCompactDecimalFormat.build(cldrFile,
        // debugCreationErrors, debugOriginals,
        // Style.SHORT, locale2);
        // captureErrors(debugCreationErrors, errors, locale, "short");
        // CompactDecimalFormat cdfs = BuildIcuCompactDecimalFormat.build(cldrFile,
        // debugCreationErrors, debugOriginals,
        // Style.LONG, locale2);
        ...
        // "\tNumeric\tCompact-Short\tCompact-Long\tFixed Numeric\tFixed Compact-Short\tFixed
        // Compact-Long\n");
        //
        // try {
    ...
    public static void showZones(
        ...
        // "class='source'", true).setSpanRows(true)
        ...
        for (MetazoneRow row : rows) {
            ...
            for (Format pattern : FORMAT_LIST) {
                String formattedZone =
                        tzformatter.getFormattedZone(tzid, pattern.toString(), date2);
                if (isGolden) {
