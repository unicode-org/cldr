...
public class XMLFileReader {
    ...
    public XMLFileReader read(String fileName, int handlers, boolean validating) {
        try (InputStream fis = new FileInputStream(fileName);) {
            ...
            throw (IllegalArgumentException) new IllegalArgumentException("Can't read " + fullName)
                .initCause(e);
        }
    }
    ...
    public static void read(
        ...
        try {
            ...
            throw (IllegalArgumentException) new IllegalArgumentException("Can't read " + systemID)
                .initCause(e);
        }
    }
