...
public class XMLFileReader {
    ...
    public static void read(
            String systemID, InputStream instr, int handlers, boolean validating, AllHandler allHandler) {
    ...
    public static void read(String systemID, InputSource is, int handlers, boolean validating, AllHandler allHandler) {
        try {
            ...
            throw (IllegalArgumentException)
                    new IllegalArgumentException("Can't read " + systemID + "\tline:\t" + e.getLineNumber())
                            .initCause(e);
    ...
    public static class LoggingHandler implements AllHandler {
        ...
        public void unparsedEntityDecl(String name, String publicId, String systemId, String notationName) {
            if (SHOW_ALL)
                Log.logln("unparsedEntityDecl: " + name + ", " + publicId + ", " + systemId + ", " + notationName);
        }
    ...
    public class MyContentHandler extends LoggingHandler {
        ...
        @Override
        public void startDTD(String name, String publicId, String systemId) throws SAXException {
            if (SHOW_ALL) Log.logln("startDTD name: " + name + ", publicId: " + publicId + ", systemId: " + systemId);
    ...
    static final class PathValueListHandler extends SimpleHandler {
        ...
        public PathValueListHandler(
                List<Pair<String, String>> data, boolean full, Function<String, String> valueFilter) {
            super();
