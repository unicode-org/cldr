 ...
 *
 * <p>Some code has been, or should be, moved here from jsp and jspf files. Reference:
 * https://unicode-org.atlassian.net/browse/CLDR-11877
 *
 * <p>TODO: in the long term, avoid generating html on the server. Use ajax. Let the client handle
 * the UI presentation.
 */
public class XMLUploader {
     ...
     * @throws IOException
     *     <p>Some code was moved here from bulkinfo.jspf Reference:
     *     https://unicode-org.atlassian.net/browse/CLDR-11877
     */
    public static void writeBulkInfoHtml(String bulkStage, Writer out) throws IOException {
        out.write("<div class='bulkNextInfo'>\n");
        out.write("<ul>\n");
        out.write("<li class='header'>Bulk Upload:</li>\n");
        String stages[] = {
            "upload", "Upload XML file", "check", "Verify valid XML", "test", "Test for CLDR errors", "submit", "Data submitted into SurveyTool"
        };
