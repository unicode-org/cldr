...
public final class XPathParts implements Freezable<XPathParts>, Comparable<XPathParts> {
        ...
        public boolean equals(Object other) {
            ...
            try {
                ...
                return element == that.element
                        && (attributes == null ? that.attributes == null : that.attributes == null ? attributes == null : attributes.equals(that.attributes));
            } catch (ClassCastException e) {
                return false;
            }
        }
    ...
    private MapComparator<String> getAttributeComparator() {
        return dtdData == null ? null : dtdData.dtdType == DtdType.ldml ? CLDRFile.getAttributeOrdering() : dtdData.getAttributeComparator();
    }
