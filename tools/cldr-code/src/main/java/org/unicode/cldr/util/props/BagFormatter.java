...
public class BagFormatter {
    ...
    public String getName(String sep, int start, int end) {
        if (
            getNameSource() == null || getNameSource() == UnicodeLabel.NULL
        ) return "";
    ...
    public BagFormatter setUnicodePropertyFactory(
    ...
    private void addMatching(
        ...
        while (true) {
            ...
            first = false;
            if (s1.equals(s2)) result.append(substitute); else result.append(
                s1
            );
        }
    }
    ...
    private class MyVisitor extends Visitor {
        ...
        public void toOutput(String s) {
            ...
            output.print(s);
            if (isHtml) output.println("</p>"); else output.print(
                lineSeparator
            );
        }
        ...
        protected void doSimpleAt(Object o) {
            if (o instanceof Map.Entry) {
                ...
                if (getValueSource() != UnicodeLabel.NULL) value =
                    "\t; " + value;
