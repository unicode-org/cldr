...
public class BagFormatter {
    ...
    private class MyVisitor extends Visitor {
        ...
        public void doAt(Object c, PrintWriter out) {
            ...
            valueSize =
                maxWidthOverride > 0 ? maxWidthOverride : getValueSource().getMaxWidth(shortValue);
        ...
        protected void doSimpleAt(Object o) {
            if (o instanceof Map.Entry) {
                ...
                String value = getValueSource() == UnicodeLabel.NULL
                    ? ""
        ...
        boolean next() {
            ...
            for (; limit < veryLimit; limit++) {
                ...
                if (DEBUG && limit > 0x9FD4) {
                    System.out.println(
                        Utility.hex(limit) + ", *Label: " + s + ", Value: " + v + ", Break: " + b
                    );
                }
