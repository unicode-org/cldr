...
public class CldrValueTest extends TestFmwk {
    ...
    public void TestValueAttributes() {
        CldrValue v =
                CldrValue.parseValue(
                        "//supplementalData/info[@digits=\"2\"][@iso4217=\"AMD\"]"
        ...
        ImmutableMap<AttributeKey, String> expected =
                ImmutableMap.of(
        ...
        assertEquals(
                "attribute order",
                expected.keySet().asList(),
                v.getValueAttributes().keySet().asList());
    }
    ...
    public void TestRetainExplicitNonDefault() {
        ...
        assertEquals(
                "path string",
                "//ldmlBCP47/keyword/key[@name=\"cu\"]/type[@name=\"xau\"]",
                v.getPath().toString());
