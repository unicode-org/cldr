...
public class PathMatcherTest extends TestFmwk {
    public void TestMatcher() {
        ...
        PathMatcher anyMonth =
                calendarPrefix.withSuffix(
                        "months/monthContext[@type=*]/monthWidth[@type=*]/month[@type=*]");
        assertEquals(
                "any month",
    ...
    private static CldrPath monthInfo(String type, String context, String width, int number) {
        return CldrPath.parseDistinguishingPath(
                String.format(
