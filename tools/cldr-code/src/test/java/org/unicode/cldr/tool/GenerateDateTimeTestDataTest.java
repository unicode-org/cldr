...
public class GenerateDateTimeTestDataTest {
  ...
  public void testComputeSkeletonFromSemanticSkeleton_applyYearStyle() {
    ...
    Object[][] casesData = {
        {"en", "gregorian",  SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.WITH_ERA, "GyMdEEE"},
        {"en", "gregorian",  SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.FULL,     "yMdEEE"},
        {"en", "gregorian",  SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.AUTO,     "yyMdEEE"},
        {"en", "japanese",   SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.WITH_ERA, "GGGGGyMdEEE"},
        {"en", "japanese",   SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.FULL,     "GGGGGyMdEEE"},
        {"en", "japanese",   SemanticSkeleton.YMDE, SemanticSkeletonLength.SHORT,  YearStyle.AUTO,     "GGGGGyMdEEE"},
    };
    ...
    for (Object[] caseDatum : casesData) {
      ...
      assertEquals(
          expected,
          actual,
          "skeleton string for locale "+ localeStr
              + ", calendar " + calendarStr
              + ", semantic skeleton " + semanticSkeleton.toString()
              + ", skeleton length " + semanticSkeletonLength.getLabel()
              + ", year style length " + yearStyle.getLabel()
      );
    }
  }
}
