...
public class LocaleMatcherTest extends TestFmwk {
    ...
    public void testPerf() {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            timeLocaleMatcher("Duration (med. supported):\t", desired, matcherLong, showMessage, iterations, timeShort);
            timeLocaleMatcher("Duration (many supported):\t", desired, matcherVeryLong, showMessage, iterations, timeShort);
        }
    }
