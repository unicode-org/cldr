...
public class TestCheckAltOnly extends TestFmwk {
    ...
    public void testSubLocale() {
        reallyTestSubLocale(TestSubLocaleMode.PARENT_PRESENT);
        reallyTestSubLocale(TestSubLocaleMode.PARENT_ABSENT);
    }

    private void reallyTestSubLocale(TestSubLocaleMode mode) {
