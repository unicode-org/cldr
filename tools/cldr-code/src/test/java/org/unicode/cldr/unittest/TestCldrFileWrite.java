...
public class TestCldrFileWrite extends TestFmwkPlus {
    ...
    public void testAllXml() {
        ...
        checkDir(
                new File(CLDRPaths.BASE_DIRECTORY),
                new File(CLDRPaths.GEN_DIRECTORY + "formatted"),
                retain);
    }

    static Function<String, String> MyFilter =
    ...
    static final Predicate<Pair<String, String>> MyPredicate =
    ...
    private void checkCompareXmlFiles(File dirIn, File dirOut, String fileName) {
        ...
        Multiset<Pair<String, String>> cldrPaths =
                HashMultiset.create(
                        XMLFileReader.loadPathValues(
                                ...
                                false,
                                MyFilter));
        Multiset<Pair<String, String>> rewritePaths =
                HashMultiset.create(
                        XMLFileReader.loadPathValues(
                                fileOut.toString(),
                                new ArrayList<Pair<String, String>>(),
    ...
    private <T extends Comparable> void checkAMinusB(
            String title, Multiset<T> a, Multiset<T> b, Predicate<T> skip) {
