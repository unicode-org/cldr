...
public class TestCollationMapMaker {
    static Transliterator javaEscape =
    ...
    public static void main(String[] args) throws IOException {
        ...
        Comparator c =
                new org.unicode.cldr.util.MultiComparator(
                        new Comparator[] {
                            col, new com.ibm.icu.text.UTF16.StringComparator(true, false, 0)
                        });
        Map mapping =
                new CollationMapMaker()
                        .generateCollatorFolding(col, new TreeMap<CharSequence, String>());
        ...
        for (String target : inverse.keySet()) {
            ...
            Log.logln(
                    com.ibm.icu.impl.Utility.hex(target)
                            + " ( "
                            + target
                            + " ) "
                            + name
