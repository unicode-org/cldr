...
public class TestKeyboardModifierSet extends TestFmwk {
    ...
    public void testParseSet_empty() {
        ...
        EnumSet<KeyboardModifierSet.Modifier> emptySet =
                EnumSet.noneOf(KeyboardModifierSet.Modifier.class);
    ...
    public void testParseSet_mix() {
        ...
        assertTrue(
                "x",
                modifierSet.contains(EnumSet.of(Modifier.optR, Modifier.shiftR, Modifier.ctrlL)));
    }
    ...
    public void testParseSet_multiple() {
        ...
        assertTrue(
                "x",
                modifierSet.contains(EnumSet.of(Modifier.cmd, Modifier.shiftL, Modifier.shiftR)));
    }
}
