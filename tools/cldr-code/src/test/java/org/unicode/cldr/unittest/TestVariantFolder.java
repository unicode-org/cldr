...
public class TestVariantFolder {
    public static void main(String[] args) {
        VariantFolder variantFolder = new VariantFolder(new VariantFolder.CaseVariantFolder());
        ...
        variantFolder = new VariantFolder(new VariantFolder.CompatibilityFolder());
        String[] testSets = {
    ...
    static Set<String> closeUnderCanonicalization(Set<String> source, Set<String> output) {
        for (String item : source) {
            ...
            for (String equiv = canonicalterator.next();
                    equiv != null;
                    equiv = canonicalterator.next()) {
                output.add(equiv);
            }
        }
        return output;
