    ...
    public int addEntries(AbstractCache cache) throws ParseException {
        ...
        while (rs.hasNext()) {
            ...
            if (code.isEmpty()) {
                ...
                // This happens for https://dbpedia.org/page/Grebo_language which has a junk extra
                // entry
                continue;
            }
            if (code.length() != 3 && code.length() != 2) {
                ...
                if (!Character.isLowerCase(code.charAt(0)) || (spaceLoc != 2 && spaceLoc != 3)) {
                    // Happens for Igbo
    ...
    public static ResultSet queryLanguageResources() throws ParseException {
        ...
        final SelectBuilder builder =
                new SelectBuilder()
                        ...
                        .addWhere(
                                resType,
                                "<" + QueryClient.PREFIX_PLG + "hypernym" + ">",
                                "dbr:Language") // Only language (not dialect etc)
                        ...
                        .addFilter(
                                "(bound(?iso6391) || bound(?iso6392))") // At least 639-1 or 639-2,
                // or both
                ;
