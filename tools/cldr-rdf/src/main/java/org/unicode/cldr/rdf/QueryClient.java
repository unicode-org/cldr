...
public class QueryClient {
    static final class QueryClientHelper {
    ...
    public static final String DBPEDIA_SPARQL_SERVER =
            System.getProperty("CLDR_DBPEDIA_SPARQL_SERVER", DEFAULT_CLDR_DBPEDIA_SPARQL_SERVER);

    public static final String DEFAULT_CLDR_WIKIDATA_SPARQL_SERVER =
            "https://query.wikidata.org/sparql";
    public static final String WIKIDATA_SPARQL_SERVER =
            System.getProperty("CLDR_WIKIDATA_SPARQL_SERVER", DEFAULT_CLDR_WIKIDATA_SPARQL_SERVER);
     ...
     * @throws IOException
     */
    public ResultSet execSelectFromSparql(final String resName, final String server)
            throws IOException {
    ...
    /**
     * A little routine to dump a ResultSet out to the command line. Note that it is destructive to
     * the ResultSet, so can't be combined with other processing.
     *
     * @param rs
     */
    ...
    public static Query loadSparql(final String resName) throws IOException {
        final String str =
                Resources.toString(
                        Resources.getResource(QueryClient.class, "sparql/" + resName + ".sparql"),
