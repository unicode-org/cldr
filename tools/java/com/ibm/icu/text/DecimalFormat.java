   ...
   /**
    ...
    private void expandAffix(String pattern, String pluralCount, StringBuffer buffer) {
        ...
        for (int i = 0; i < pattern.length();) {
            ...
            case CURRENCY_SIGN:
                ...
                continue;
            case PATTERN_PERCENT:
                String percentString = symbols.getPercentString();
                buffer.append(percentString);
                continue;
            case PATTERN_PER_MILLE:
                c = symbols.getPerMill();
                break;
    ...
    private int appendAffix(StringBuffer buf, boolean isNegative, boolean isPrefix,
        ...
        if (parseAttr) {
            ...
            // TODO: Consider if Permille can be more than one character.
        ...
        if (fieldPosition.getFieldAttribute() == NumberFormat.Field.SIGN) {
            ...
            String percentString = symbols.getPercentString();
            int firstPos = affix.indexOf(percentString);
            if (firstPos > -1) {
                int startPos = buf.length() + firstPos;
                fieldPosition.setBeginIndex(startPos);
                fieldPosition.setEndIndex(startPos + percentString.length());
            }
