// Copied this version from ICU4J r39027 to enhance with
// get/setPercentString, setMinusString, setPluString
...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    /**
     * Returns the string used to represent percent sign.
     * @return the percent sign string
     * @internal
    ...
    public void setPercent(char percent) {
        ...
        // Also updates percentString
        char[] percentArray = { percent };
        percentString = new String(percentArray);
    }

    /**
     * Sets the string used to represent percent sign.
     * @deprecated This API is ICU internal only.
     */
    @Deprecated
    public void setPercentString(String percentString) {
        this.percentString = percentString;
        percent = (percentString.length() > 1 && isBidiMark(percentString.charAt(0)))? percentString.charAt(1): percentString.charAt(0);
    }
    ...
    */
    ...
    /**
     * Sets the string used to represent plus sign.
     * @deprecated This API is ICU internal only.
     */
    @Deprecated
    ...
    public boolean equals(Object obj) {
        ...
        percentString.equals(other.percentString) &&
    ...
    private void initialize( ULocale locale ) {
        ...
        percentString = numberElements[3];
        percent = (percentString.length() > 1 && isBidiMark(percentString.charAt(0)))? percentString.charAt(1): percentString.charAt(0);
    ...
    private String percentString = null;
