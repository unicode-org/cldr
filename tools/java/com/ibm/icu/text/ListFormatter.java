...
final public class ListFormatter implements Transform<Collection<String>, String>{
     ...
     * @param start string for the start of a list items, containing {0} for the first, and {1} for the rest.
     * @param middle string for the start of a list items, containing {0} for the first part of the list, and {1} for the rest of the list.
     * @param end string for the end of a list items, containing {0} for the first part of the list, and {1} for the last item.
     */
    ...
    public String format(Collection<Object> items) {
        ...
        switch (count) {
        case 0: return "";
        case 1: return it.next().toString();
        case 2: return format2(two, it.next(), it.next());
        }
