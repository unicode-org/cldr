...
public class FormatSpecialData2 {
    ...
    private static int getIcuPropEnum(RemapType type) {
        ...
        switch (type) {
        case SCRIPT:
            icuProp = UProperty.SCRIPT;
            break;
        default:
            icuProp = UProperty.GENERAL_CATEGORY;
            break;
        }
        return icuProp;
    }
