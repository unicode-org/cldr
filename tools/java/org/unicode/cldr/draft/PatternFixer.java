...
public class PatternFixer {
   ...
   * <p>The reason for supporting more than just Java is so that this can be use in build-time tools for generating
   * fixed regex pattern strings.
   */
  ...
  private enum State {BASE, HAVE_SLASH, HAVE_Q, HAVE_Q_SLASH};
  /**
