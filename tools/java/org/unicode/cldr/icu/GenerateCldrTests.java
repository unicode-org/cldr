...
public class GenerateCldrTests {
	...
	*/
	...
	static {
		...
		Utility.registerTransliteratorFromFile("Latin-Armenian", options[TZADIR].value, null);
		Utility.registerTransliteratorFromFile("Latin-Ethiopic", options[TZADIR].value, null);
		Utility.registerTransliteratorFromFile("Cyrillic-Latin", options[TZADIR].value, null);
		Utility.registerTransliteratorFromFile("Arabic-Latin", options[TZADIR].value, null);		
	}
