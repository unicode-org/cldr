...
public class ListNumbers {
    ...
    private static void printTable(ULocale loc, RuleBasedNumberFormat[] rbnfs) {
        ...
        for (RuleBasedNumberFormat rbnf : rbnfs) {
            ...
            System.out.print("<th colspan=\"" + numColumns + "\" style=\"text-align:center;\">"+getRulePrefix(rbnf.getDefaultRuleSetName()));
            System.out.print("<br/><span style=\"color: gray\">Default = " + getDisplayName(rbnf, rbnf.getDefaultRuleSetName()));
        ...
        if (args.length > 1) {
            ...
            for (ULocale loc : NumberFormat.getAvailableULocales()) {
                ...
                try {
                    ...
                    UResourceBundle bundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt"+VersionInfo.ICU_DATA_VERSION_PATH+"/rbnf", loc);
                    if (bundle.getSize() == 2) {
