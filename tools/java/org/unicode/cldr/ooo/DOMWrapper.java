...
public class DOMWrapper
{
     ...
     * returns a Hashtable of Hashtables (outer key = passed in attribute's value, inner key=attr name, value=attr
     * value)
     */
     ...
     */
    public String getAttributesFromElement(String parentElement, String element, String attribName,
        String parentAttribName, String parentAttribValue)
    {
     ...
     * and provided parentElement has an attribute = attribName whose value = parentAttribValue
     */
    public Vector getAttributesFromElement2(String parentElement, String element, String attribName,
        String parentAttribName, String parentAttribValue)
    {
        if ((parentElement == null) || (element == null) || (attribName == null)
            || (parentAttribName == null) || (parentAttribValue == null))
     ...
     */
    public Hashtable getTextFromElementsAndGGPAttrib(String parentElement, String element, String elementSibling,
        String greatGrandParentAttrib)
    {
                    ...
                    { // they share the same GGParent attribute so put in same inner nexted map
                        if ((elementText != null) && (siblingElementText != null))
                        {
                            if (inner.containsKey(elementText) == false)
                                ...
                                System.err.println("WARNING 2: duplicate " + elementText + " element value under "
                                    + parentElement);
                        }

                    }
                    else
                    { // belong to a different category so write the previous inner nexted map to outer map and start a
                      // new inner map
                        ...
                        if (outer.containsKey(prevGreatGParentAttribValue) == false)
                            ...
                            System.err.println("WARNING 3: duplicate " + prevGreatGParentAttribValue + " value for "
                                + greatGrandParentAttrib);
                        ...
                        if ((elementText != null) && (siblingElementText != null))
                        {
                            if (inner.containsKey(elementText) == false)
                                ...
                                System.err.println("WARNING 4: duplicate " + elementText + " element value under "
                                    + parentElement);
                        }
                    }
        ...
        if (prevGreatGParentAttribValue.compareTo("unknown") != 0)
        {
            if (outer.containsKey(prevGreatGParentAttribValue) == false)
                ...
                System.err.println("WARNING 5: duplicate " + prevGreatGParentAttribValue + " value for "
                    + greatGrandParentAttrib);
        }
        return outer;
    }
                ...
                if (grandParentNode != null)
                {
                    ...
                    if (grandParentAttribValue != null)
                    {
                        if (outer.containsKey(grandParentAttribValue) == false)
                            ...
                            System.err.println("WARNING 6: duplicate " + grandParentAttribValue + " value for "
                                + grandParentAttrib);
                    }
                }
            }
    ...
    /*
     * retrieves text value of an element (where element is identified by its own name, that of its parent and that of
     * its grandparent)
     * and the values of one of the grandParent's attribute
     * and returns a Hashtable where key = grandParent's attribute, value = element's value
     */
    public Hashtable getTextFromElementsAndGPAttrib(String element, String parentElement, String gparentElement,
        String grandParentAttrib)
    {
                    ...
                    && (nodeGParent.getNodeName().compareTo(gparentElement) == 0))
                {
                    ...
                    if ((grandParentAttribValue != null) && (elementText != null))
                    {
                        if (outer.containsKey(grandParentAttribValue) == false)
                            ...
                            System.err.println("WARNING 7: duplicate " + grandParentAttribValue + " value for "
                                + grandParentAttrib);
                    }
                }
            }
     ...
     */
    public Vector getTextFromElementsAndGPAttrib(String element, String elAttrib, String gparentElement,
        String grandParentAttrib, String gParentAttribValue)
    {
        if ((element == null) || (elAttrib == null) || (gparentElement == null) || (grandParentAttrib == null)
            || (gParentAttribValue == null))
            return null;
                ...
                if (nodeParent != null)
                {
                    ...
                    if ((parentAttribValue != null) && (elementText != null))
                    {
                        if (outer.containsKey(parentAttribValue) == false)
                            ...
                            System.err.println("WARNING 8: duplicate " + parentElement + " with " + parentAttrib
                                + " = " + parentAttribValue);
                    }
                }
            }
    ...
    public Hashtable getAttributeValues(String element, String attribute, String parentElement, String parentAttribute)
    {
        ...
        for (int i = 0; i < nl.getLength(); i++)
        {
            ...
            // if we find the element's attribute we'return interested in then get the parentElement's attribute of
            // interest
            if (attributeValue != null)
            {
     ...
     */
    public String getTextFromElementWithAttrib(String element, String attribute, String attribValue, String parent,
        String grandparent)
    {
        String text = "";
     ...
     * returns a Vector of Hashtables (key "innerText"=>data is String, key "attributes"=>hashtable (key=attr name,
     * value=attr value))
     ...
     */
    public Hashtable getTextFromAllElementsWithGGGParent(String element, String attribute, String parent,
        String parentAttribute, String parentAttributeValue, String gparent, String ggparent, String gggparent,
        String gggparentAttribute)
    {
        Hashtable allElements = new Hashtable();
        if ((element == null) || (attribute == null) || (parent == null) || (parentAttribute == null)
            || (parentAttributeValue == null) || (gparent == null) || (ggparent == null) || (gggparent == null)
            || (gggparentAttribute == null))
            return null;
                            ...
                            && (nodeGGGParent.getNodeName().compareTo(gggparent) == 0))
                        {
                            ...
                            if ((gggparentAttributeValue != null) && (nodeText != null))
                            {
                                ...
                                if (innerTable.get(str) == null)
                                    ...
                                    System.err.println("WARNING 13: duplicate " + str + " with " + attribute + " = "
                                        + nodeText);
                            } // end if
                        } // end if
                    } // end if
     ...
     */
    public Hashtable getTextFromAllElementsWithGGGParent(String element, String attribute, String parent,
        String parentAttribute, String parentAttributeValue,
        String gparent, String ggparent, String gggparent, String gggparentAttribute, String gparentAttribute,
        String gparentAttribValue)
    {
        Hashtable allElements = new Hashtable();
        if ((element == null) || (attribute == null) || (parent == null) || (parentAttribute == null)
            || (parentAttributeValue == null) || (gparent == null) || (ggparent == null) || (gggparent == null)
     ...
     * Hashtables (key=attribute, value=element text.
     */
    public Hashtable getTextFromAllElementsWithGGParent(String element, String attribute, String parent,
        String gparent, String ggparent, String ggparentAttribute)
    {
        Hashtable allElements = new Hashtable();
        if ((element == null) || (attribute == null) || (parent == null) || (gparent == null) || (ggparent == null)
            || (ggparentAttribute == null))
            return null;
     ...
     */
    public Hashtable getTextFromAllElementsWithGGParent(String element, String parent, String gparent, String ggparent,
        String ggparentAttribute)
    {
        Hashtable allElements = new Hashtable();
        if ((element == null) || (parent == null) || (gparent == null) || (ggparent == null)
            || (ggparentAttribute == null))
            return null;
                ...
                && (nodeParent.getNodeName().compareTo(parent) == 0))
            {
                    ...
                    && (nodeGParent.getNodeName().compareTo(gparent) == 0))
                {
                        ...
                        && (nodeGGParent.getNodeName().compareTo(ggparent) == 0))
                    {
                        ...
                        if ((ggparentAttributeValue != null) && (ggparentAttributeValue.length() > 0)
                            && (nodeText != null))
                        {
                            ...
                            if (text == null)
                                ...
                                System.err.println("WARNING 15: duplicate " + ggparentAttributeValue + " under "
                                    + ggparentAttribute);
                        }
                    } // end if
                } // end if
     ...
     */
    public Hashtable getAttributeFromElementsAndGPAttrib(String parentElement, String element, String elementAttrib,
        String grandParentAttrib)
    {
                ...
                if ((attributeValue != null) && (grandParentNode != null))
                {
                    ...
                    if (gparentAttribValue != null)
                    {
                        if (outer.containsKey(gparentAttribValue) == false)
                            ...
                            System.err.println("WARNING 16: duplicate " + gparentAttribValue + " for "
                                + grandParentAttrib);
                    }
                }
            }
    ...
    /*
     * public Hashtable getAttribsFrom_El_parent_GP(String el, String elAttr, String parEl, String parAttr, String gpEl,
     * String gpAttr)
     * {
     ...
     * String iso4217currency = getAttributesFromElement(gpEl, parEl, parAttr, gpAttr,
     * (String)iso3166REgions.elementAt(i));
     * if (iso4217currency != null)
     * {
     * iso4217currencies.add(0, iso4217currency);
     * 
     * Vector iso4217currency_alt = getTextFromElementsAndGPAttrib (el, elAttr, gpEl, gpAttr,
     * (String)iso3166REgions.elementAt(i));
     ...
     * for (int i=0; i < iso3166REgions.size(); i++)
     * {
     * Vector iso4217currencies = getAttributesFromElement2(parEl, el, elAttr, parAttr,
     * (String)iso3166REgions.elementAt(i));
     * table.put(iso3166REgions.elementAt(i), iso4217currencies);
     * }
     * return table;
