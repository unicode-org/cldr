...
public class LDMLLocaleWriter extends XMLWriter
{
    ...
    public boolean open(String namespace, String dtdLocation, String nsDTD, String cldrVersion)
    {
        ...
        else
        {
            ...
            {
                dtd = dtd + "\n" + "[\n" + "\t<!ENTITY % " + namespace + " SYSTEM \"http://www.unicode.org/cldr/dtd/"
                    + cldrVersion + "/" + nsDTD + "\">\n%" + namespace + ";\n]\n>";
            }
        }
    ...
    protected void writeIdentity(Locale locale, String message)
    {
        ...
        String versionStr = "<" + LDMLConstants.VERSION + " " + LDMLConstants.NUMBER + "=\"" + version + "\">" + msgStr
            + LDMLConstants.VERSION_C;
        println(versionStr);

        String generationStr = "<" + LDMLConstants.GENERATION + " " + LDMLConstants.DATE
            + "=\"$Date$\"/>";
     ...
     * indent();
     * String lang = "<" + LDMLConstants.LANGUAGE + " " + LDMLConstants.TYPE + "=\"" + language_type + "\">" + language
     * + LDMLConstants.LANGUAGE_C;
     * println(lang);
     * outdent();
     ...
     * indent();
     * String terr = "<" + LDMLConstants.TERRITORY + " " + LDMLConstants.TYPE + "=\"" + territory_type + "\">" +
     * territory + LDMLConstants.TERRITORY_C;
     * println(terr);
     * outdent();
    ...
    protected void writeDayWidth(Hashtable days, String dayWidthType)
    {
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.SUN + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MON + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.TUE + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.WED + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.THU + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.FRI + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        ...
        if (day != null)
        {
            dayStr = "<" + LDMLConstants.DAY + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.SAT + "\">" + day
                + LDMLConstants.DAY_C;
            println(dayStr);
        }
        outdent();
    ...
    protected void writeMonthWidth(Hashtable months, String monthWidthType)
    {
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_1 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        month = (String) months.get(LDMLConstants.MONTH_2);
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_2 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_3 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_4 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_5 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_6 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_7 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_8 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_9 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_10 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_11 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_12 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        ...
        if (month != null)
        {
            monthStr = "<" + LDMLConstants.MONTH + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.MONTH_13 + "\">"
                + month + LDMLConstants.MONTH_C;
            println(monthStr);
        }
        outdent();
    ...
    protected void writeQuarterWidth(Hashtable data, String widthType)
    {
        ...
        if (quarter != null)
        {
            quarterStr = "<" + LDMLConstants.QUARTER + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.Q_1 + "\">"
                + quarter + LDMLConstants.QUARTER_C;
            println(quarterStr);
        }
        quarter = (String) data.get(LDMLConstants.Q_2);
        if (quarter != null)
        {
            quarterStr = "<" + LDMLConstants.QUARTER + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.Q_2 + "\">"
                + quarter + LDMLConstants.QUARTER_C;
            println(quarterStr);
        }
        ...
        if (quarter != null)
        {
            quarterStr = "<" + LDMLConstants.QUARTER + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.Q_3 + "\">"
                + quarter + LDMLConstants.QUARTER_C;
            println(quarterStr);
        }
        ...
        if (quarter != null)
        {
            quarterStr = "<" + LDMLConstants.QUARTER + " " + LDMLConstants.TYPE + "=\"" + LDMLConstants.Q_4 + "\">"
                + quarter + LDMLConstants.QUARTER_C;
            println(quarterStr);
        }
        outdent();
    ...
    protected void writeEras(Hashtable eras)
    {
        ...
        while (enKeys.hasMoreElements() == true)
        {
            ...
            {
                String eraStr = "<" + LDMLConstants.ERA + " " + LDMLConstants.TYPE + "=\"" + key + "\">" + value
                    + LDMLConstants.ERA_C;
                println(eraStr);
            }
        }
    ...
    {
        if ((pattern == null) || (outerEl_o == null) || (outerEl_c == null) || (innerEl_o == null)
            || (innerEl_c == null))
            return;
    ...
    protected void printNS(String namespace, String element, Hashtable attribs, boolean bIsOpen,
        boolean bHasSubElementsOrData, boolean bNewLine)
    {
    ...
    protected void printSpecial(String namespace, String www, Hashtable attribs, boolean bHasSubElementsOrData,
        boolean bNewLine)
    {
    ...
    protected void print(String element, Hashtable attribs, boolean bIsOpen, boolean bHasSubElementsOrData,
        boolean bNewLine)
    {
