...
public class LDMLToOOConverter
{
    ...
    private static final int
        ...
        SUPP_DIR = 6,
        OUT_DIR = 7,
        SKIP_IF_NO_CLDR = 8, // skip this locale if it doesn't exsit in CLDR, makes it easier to look at comparison
                             // charts
    ...
    private void processBulk()
    {
        ...
        {
            System.err.println(skippedExisting
                + " file(s) were not converted because the destination files already existed.");
    ...
    private boolean processSingle(String locale, String out_file)
    {
        ...
        {
            printWarning("Skipping this locale " + locale
                + " as no source OpenOffice.org LDML or CLDR file were not found");
            return false;
        }
        ...
        if (reader_ooo_ldml.m_LangDefaultName != null)
            data.put(OOConstants.LANGUAGE, reader_ooo_ldml.m_LangDefaultName);
        ...
        if (reader_ooo_ldml.m_TerritoryDefaultName != null)
            data.put(OOConstants.COUNTRY, reader_ooo_ldml.m_TerritoryDefaultName);
        ...
        {
            writer.writeLC_FORMATRef(reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo,
                reader_ooo_ldml.m_FormatRefLocale);
        }
        ...
        else
        {
            ...
            // fixed number
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_FixedNFormats, reader_ooo_ldml.m_FixedNPatterns,
                reader_ooo_ldml.m_FixedNOO, reader_ooo_ldml.m_FixedDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);

            // scientific number
            m_outFormatElements.clear();
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_SciNFormats, reader_ooo_ldml.m_SciNPatterns,
                reader_ooo_ldml.m_SciNOO, reader_ooo_ldml.m_SciDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_PercNFormats, reader_ooo_ldml.m_PercNPatterns,
                reader_ooo_ldml.m_PercNOO, reader_ooo_ldml.m_PercDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            // LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_FractNFormats, reader_ooo_ldml.m_FractNPatterns,
            // reader_ooo_ldml.m_FractNOO, reader_ooo_ldml.m_FractNDefaultName, m_outFormatElements, m_outFormatCodes,
            // m_outFormatDefaultNames);
            // lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
            // lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_CurrNFormats, reader_ooo_ldml.m_CurrNPatterns,
                reader_ooo_ldml.m_CurrNOO, reader_ooo_ldml.m_CurrNDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_DateFormats, reader_ooo_ldml.m_DatePatterns,
                reader_ooo_ldml.m_DateOO, reader_ooo_ldml.m_DateDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_TimeFormats, reader_ooo_ldml.m_TimePatterns,
                reader_ooo_ldml.m_TimeOO, reader_ooo_ldml.m_TimeDefaultName, m_outFormatElements, m_outFormatCodes,
                m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
            ...
            m_outFormatCodes.clear();
            m_outFormatDefaultNames.clear();
            LDMLToOOMapper.MapFormatElements(reader_ooo_ldml.m_DateTimeFormats, reader_ooo_ldml.m_DateTimePatterns,
                reader_ooo_ldml.m_DateTimeOO, reader_ooo_ldml.m_DateTimeDefaultName, m_outFormatElements,
                m_outFormatCodes, m_outFormatDefaultNames);
            lcformatOpened = writer.writeLC_FORMAT(m_outFormatElements, m_outFormatCodes, m_outFormatDefaultNames,
                lcformatOpened, reader_ooo_ldml.m_FormatReplaceFrom, reader_ooo_ldml.m_FormatReplaceTo);
        ...
        if (((wideEraReader.m_EraNames != null) && (reader_ooo_ldml.m_EraNames.size() > 0))
            || ((reader_cldr.m_AbbrEras != null) && (reader_cldr.m_AbbrEras.size() > 0)))
        {
            Hashtable eras = null;
        ...
        if (locale.substring(0, 2).equals("eo") || locale.substring(0, 2).equals("ia")
            || locale.substring(0, 2).equals("eu"))
        ...
        writer.WriteLC_CURRENCY(reader_cldr.m_CurrencyData_cldr, reader_ooo_ldml.m_CurrencyData_ooo, m_suppData,
            m_bRoundTrip, reader_ooo_ldml.m_TerritoryID);
            ...
            || m_bTemplate == true)
        {
            ...
            // theyt are stored in LDMLReaderForOO.m_abbrQuarters and m_abbrQuarters regardless of where they are read
            // from
            ...
            if (m_bTemplate == true)
            {
                ...
                LDMLToOOMapper.MapQuarters(reservedWords, reader_ooo_ldml.m_AbbrQuarters,
                    reader_ooo_ldml.m_WideQuarters);
        ...
        else
        {
            ...
            if ((reader_ooo_ldml.m_OutlineNumberingLevels != null)
                && (reader_ooo_ldml.m_OutlineNumberingLevels.size() > 0))
            {
                outlineNumberingLevelsOO = LDMLToOOMapper
                    .MapOutlineNumberingLevels(reader_ooo_ldml.m_OutlineNumberingLevels);
            }
    ...
    void printUsage()
    {
        ...
        System.err
            .println("  1. Conversion back to OpenOffice.org XML of data which was previously converted to LDML.");
        ...
        System.err
            .println("  2. Conversion to OO XML of OpenOffice.org specific data from 1 above merged with CLDR standard data.");
        System.err
            .println("     this is the step to perform when it is desired to migrate OpenOffice.org data to CLDR");
        ...
        System.err
            .println("     this is the step to perform when generating date for a brand new OpenOffice.org locale");
        ...
        System.err
            .println("  -e         generate OO.o template file for new locales (OO.o specific elements are empty)");
    ...
    {
        // enc if specified will be used to compose output filename, so it should normally be null (except for Solaris
        // maybe)
