...
public class OOLocaleWriter extends XMLWriter
{
    ...
    public void writeLC_INFO(Hashtable data)
    {
        ...
        if (countryID != null)
            ...
            println("<" + OOConstants.COUNTRY_ID + "/>"); // mandatory element in OO locale.dtd but some locales have no
                                                          // country like ia.xml
        ...
        if (country != null)
            ...
            println("<" + OOConstants.DEFAULT_NAME + "/>"); // mandatory element in OO locale.dtd but some locales have
                                                            // no country like ia.xml
        outdent();
        println("</" + OOConstants.COUNTRY + ">");
    ...
    public void writeLC_CTYPE(Hashtable data)
    {
        ...
        if ((Separators != null) && (Separators.size() > 0))
        {
            ...
            String dateSeparator = m_bTemplate == false ? (String) Separators.get(OOConstants.DATE_SEPARATOR)
                : OOConstants.NO_DATA;
            ...
            if ((thousandSeparator != null) && (thousandSeparator.length() > 0))
                println("<" + OOConstants.THOUSAND_SEPARATOR + ">" + thousandSeparator + "</"
                    + OOConstants.THOUSAND_SEPARATOR + ">");
            else
            ...
            if ((decimalSeparator != null) && (decimalSeparator.length() > 0))
                println("<" + OOConstants.DECIMAL_SEPARATOR + ">" + decimalSeparator + "</"
                    + OOConstants.DECIMAL_SEPARATOR + ">");
            else
                println("<" + OOConstants.DECIMAL_SEPARATOR + "/>");

            String timeSeparator = m_bTemplate == false ? (String) Separators.get(OOConstants.TIME_SEPARATOR)
                : OOConstants.NO_DATA;
            ...
            String time100SecSeparator = m_bTemplate == false ? (String) Separators
                .get(OOConstants.TIME_100SEC_SEPARATOR) : OOConstants.NO_DATA;
            if ((time100SecSeparator != null) && (time100SecSeparator.length() > 0))
                println("<" + OOConstants.TIME_100SEC_SEPARATOR + ">" + time100SecSeparator + "</"
                    + OOConstants.TIME_100SEC_SEPARATOR + ">");
            else
            ...
            String longDateDayOfWeekSeparator = m_bTemplate == false ? (String) Separators
                .get(OOConstants.LONG_DATE_DAY_OF_WEEK_SEPARATOR) : OOConstants.NO_DATA;
            if ((longDateDayOfWeekSeparator != null) && (longDateDayOfWeekSeparator.length() > 0))
                println("<" + OOConstants.LONG_DATE_DAY_OF_WEEK_SEPARATOR + ">" + longDateDayOfWeekSeparator + "</"
                    + OOConstants.LONG_DATE_DAY_OF_WEEK_SEPARATOR + ">");
            else
                println("<" + OOConstants.LONG_DATE_DAY_OF_WEEK_SEPARATOR + "/>");

            String longDateDaySeparator = m_bTemplate == false ? (String) Separators
                .get(OOConstants.LONG_DATE_DAY_SEPARATOR) : OOConstants.NO_DATA;
            if ((longDateDaySeparator != null) && (longDateDaySeparator.length() > 0))
                println("<" + OOConstants.LONG_DATE_DAY_SEPARATOR + ">" + longDateDaySeparator + "</"
                    + OOConstants.LONG_DATE_DAY_SEPARATOR + ">");
            else
                println("<" + OOConstants.LONG_DATE_DAY_SEPARATOR + "/>");

            String longDateMonthSeparator = m_bTemplate == false ? (String) Separators
                .get(OOConstants.LONG_DATE_MONTH_SEPARATOR) : OOConstants.NO_DATA;
            if ((longDateMonthSeparator != null) && (longDateMonthSeparator.length() > 0))
                println("<" + OOConstants.LONG_DATE_MONTH_SEPARATOR + ">" + longDateMonthSeparator + "</"
                    + OOConstants.LONG_DATE_MONTH_SEPARATOR + ">");
            else
                println("<" + OOConstants.LONG_DATE_MONTH_SEPARATOR + "/>");

            String longDateYearSeparator = m_bTemplate == false ? (String) Separators
                .get(OOConstants.LONG_DATE_YEAR_SEPARATOR) : OOConstants.NO_DATA;
            if ((longDateYearSeparator != null) && (longDateYearSeparator.length() > 0))
                println("<" + OOConstants.LONG_DATE_YEAR_SEPARATOR + ">" + longDateYearSeparator + "</"
                    + OOConstants.LONG_DATE_YEAR_SEPARATOR + ">");
            else
        ...
        if ((Markers != null) && (Markers.size() > 0))
        {
            ...
            if ((doubleQuotationStart != null) && (doubleQuotationStart.length() > 0))
                println("<" + OOConstants.DOUBLE_QUOTATION_START + ">" + doubleQuotationStart + "</"
                    + OOConstants.DOUBLE_QUOTATION_START + ">");
            ...
            if ((doubleQuotationEnd != null) && (doubleQuotationEnd.length() > 0))
                println("<" + OOConstants.DOUBLE_QUOTATION_END + ">" + doubleQuotationEnd + "</"
                    + OOConstants.DOUBLE_QUOTATION_END + ">");
        ...
        if ((measurementSystem != null) && (measurementSystem.length() > 0))
            println("<" + OOConstants.MEASUREMENT_SYSTEM + ">" + measurementSystem + "</"
                + OOConstants.MEASUREMENT_SYSTEM + ">");
    ...
    public boolean writeLC_FORMAT(Hashtable inFormatElements, Hashtable inFormatCodes, Hashtable inFormatDefaultNames,
        boolean inHasOpened, String replaceFrom, String replaceTo)
    {
        ...
        if (!m_hasOpened)
        {
            ...
            if ((replaceFrom != null) && (replaceTo != null))
                lcFormat.append(" " + OOConstants.REPLACE_FROM_SMALL + "=\"" + replaceFrom + "\" "
                    + OOConstants.REPLACE_TO_SMALL + "=\"" + replaceTo + "\"");
            lcFormat.append(">");
            ...
            while (keys.hasMoreElements() == true)
            {
                ...
                if ((key != null) && (key.length() > 0))
                {
                    ...
                    if ((elementAttribs != null) && (elementAttribs.size() > 0))
                    {
                        ...
                        StringBuffer formatLine = new StringBuffer("<" + OOConstants.FORMAT_ELEMENT + " "
                            + OOConstants.MSGID + "=\"" + key + "\"");
                        ...
                        if ((defaultName != null) && (defaultName.length() > 0))
                            println("<" + OOConstants.DEFAULT_NAME + ">" + defaultName + "</"
                                + OOConstants.DEFAULT_NAME + ">");
    ...
    public void writeLC_COLLATION(Hashtable data, String ref)
    {
        ...
        while (collationOptsKeys.hasMoreElements() == true)
        {
            ...
            if ((transliterationModule != null) && (transliterationModule.length() > 0))
            {
                ...
                indent();
                println("<" + OOConstants.TRANSLITERATION_MODULES + ">" + transliterationModule + "</"
                    + OOConstants.TRANSLITERATION_MODULES + ">");
                outdent();
                println("</" + OOConstants.COLLATION_OPTIONS + ">");
            }
        }// end while
            ...
            while (calEnum.hasMoreElements())
            {
                ...
                if (calendar != null)
                {
                    ...
                    if ((calendarType != null) && (calendarType.length() > 0))
                    {
                        ...
                        StringBuffer calTag = new StringBuffer("<" + OOConstants.CALENDAR + " " + OOConstants.UNOID
                            + "=\"" + calendarType + "\"");
    ...
    private void writeDays(Hashtable data, String unoid)
    {
        ...
        if (((daysAbbr != null) && (daysAbbr.size() > 0)) || ((daysFull != null) && (daysFull.size() > 0)))
        {
            ...
            if (((daysAbbrvUnoid != null) && (daysAbbrvUnoid.size() > 0))
                || ((daysFullUnoid != null) && (daysFullUnoid.size() > 0)))
            {
    ...
    private void writeMonths(Hashtable data, String unoid)
    {
        ...
        if (((monthsAbbr != null) && (monthsAbbr.size() > 0)) || ((monthsFull != null) && (monthsFull.size() > 0)))
        {
            ...
            if (((monthsAbbrvUnoid != null) && (monthsAbbrvUnoid.size() > 0))
                || ((monthsFullUnoid != null) && (monthsFullUnoid.size() > 0)))
            {
    ...
    private void writeSingleEra(Hashtable calendarEra, String eraID)
    {
        ...
        // sometimes this data is not available but elements are mandatory in OO locale.dtd so write <element/> if
        // absent
        if (abbr != null)
    ...
    public void writeMinDays(Hashtable data, String calendarType)
    {
        ...
        if (minDays != null)
            println("<" + OOConstants.MINIMAL_DAYS_IN_FIRST_WEEK + ">" + minDays + "</"
                + OOConstants.MINIMAL_DAYS_IN_FIRST_WEEK + ">");
        else
            println("<" + OOConstants.MINIMAL_DAYS_IN_FIRST_WEEK + "/>");
    ...
    {
        if ((currencyData_cldr == null && currencyData_ooo == null)
            || (currencyData_cldr.size() == 0 && currencyData_ooo.size() == 0))
            return;
        ...
        else
        {
            ...
            {
                // inner_ooo order : CurrencyID,symbol,code,name, blank ,default, usedInCompatibleFormatCode, legacyOnly
                // (if defined)
                ...
                // System.err.println ("Writer id="+(String)inner_ooo.elementAt(0) + " symbol="+ symbol + " code=" +
                // code + " name="+ name + " blank=" + (String)inner_ooo.elementAt(4) + "deflt=" + deflt +
                // "uicfc="+(String)inner_ooo.elementAt(6));
                ...
                String uicfc = " " + OOConstants.USED_IN_COMPARTIBLE_FORMATCODES_SMALL + "=\""
                    + (String) inner_ooo.elementAt(6) + "\"";
                String legacy = "";
                if (inner_ooo.size() > 7)
                    legacy = " " + OOConstants.LEGACY_ONLY + "=\"" + (String) inner_ooo.elementAt(7) + "\"";
                println("<" + OOConstants.CURRENCY + def + uicfc + legacy + ">");
                indent();
                println("<" + OOConstants.CURRENCY_ID + ">" + (String) inner_ooo.elementAt(0) + "</"
                    + OOConstants.CURRENCY_ID + ">");
                println("<" + OOConstants.CURRENCY_SYMBOL + ">" + symbol + "</" + OOConstants.CURRENCY_SYMBOL + ">");
                println("<" + OOConstants.BANK_SYMBOL + ">" + code + "</" + OOConstants.BANK_SYMBOL + ">");
                println("<" + OOConstants.CURRENCY_NAME + ">" + name + "</" + OOConstants.CURRENCY_NAME + ">");
    ...
    public void WriteLC_MISC(Hashtable data, String ref)
    {
        ...
        else if ((data != null) && (data.size() != 0))
        {
            ...
            if (((forbiddenLineBeg != null) && (forbiddenLineBeg.length() > 0))
                || ((forbiddenLineEnd != null) && (forbiddenLineEnd.length() > 0)) || (m_bTemplate == true))
            {
                ...
                if (flb != null && flb.length() > 0)
                    println("<" + OOConstants.FORBIDDEN_LINE_BEGIN_CHARACTERS + ">" + flb + "</"
                        + OOConstants.FORBIDDEN_LINE_BEGIN_CHARACTERS + ">");
                // }
                ...
                if (fle != null && fle.length() > 0)
                    println("<" + OOConstants.FORBIDDEN_LINE_END_CHARACTERS + ">" + fle + "</"
                        + OOConstants.FORBIDDEN_LINE_END_CHARACTERS + ">");
                // }
    ...
    {
        println("<" + OOConstants.LC_FORMAT + " " + OOConstants.REPLACE_FROM_SMALL + "=\"" + OOConstants.NO_DATA_Q
            + "\" " + OOConstants.REPLACE_TO_SMALL + "=\"" + OOConstants.NO_DATA_Q + "\">");
        indent();
    ...
    public void writeLC_COLLATION_template()
    {
        println("<" + OOConstants.LC_COLLATION + ">");
        indent();
        println("<" + OOConstants.COLLATOR + " " + OOConstants.DEFAULT + "=\"" + OOConstants.TRUE_FALSE + "\" "
            + OOConstants.UNOID + "=\"" + OOConstants.NO_DATA + "\"/>");
        println("<" + OOConstants.COLLATION_OPTIONS + ">");
        indent();
        println("<" + OOConstants.TRANSLITERATION_MODULES + ">" + OOConstants.NO_DATA + "</"
            + OOConstants.TRANSLITERATION_MODULES + ">");
        outdent();
        println("</" + OOConstants.COLLATION_OPTIONS + ">");
        outdent();
    ...
    public void writeLC_INDEX_template()
    {
        ...
        println("<" + OOConstants.INDEX_KEY + " " + OOConstants.DEFAULT + "=\"" + OOConstants.TRUE_FALSE + "\" " +
            OOConstants.PHONETIC + "=\"" + OOConstants.TRUE_FALSE + "\" " + OOConstants.UNOID + "=\""
            + OOConstants.NO_DATA + "\">" +
            OOConstants.NO_DATA + "</" + OOConstants.INDEX_KEY + ">");
        for (int i = 0; i < 2; i++)
            // usually but not always have 2
            println("<" + OOConstants.UNICODE_SCRIPT + ">" + OOConstants.NO_DATA + "</" + OOConstants.UNICODE_SCRIPT
                + ">");
        for (int i = 0; i < 2; i++)
            // pretty much always have 8
            println("<" + OOConstants.FOLLOW_PAGE_WORD + ">" + OOConstants.NO_DATA + "</"
                + OOConstants.FOLLOW_PAGE_WORD + ">");
        outdent();
        println("</" + OOConstants.LC_INDEX + ">");
    }
    ...
    public void writeLC_NumberingLevel_template()
    {
        ...
        for (int i = 0; i < 8; i++)
            ...
            println("<" + OOConstants.NUMBERING_LEVEL + " " + OOConstants.NUM_TYPE + "=\"" + OOConstants.NO_DATA
                + "\" " +
                OOConstants.PREFIX + "=\"" + OOConstants.NO_DATA + "\" " + OOConstants.SUFFIX + "=\""
                + OOConstants.NO_DATA + "\"/>");
        outdent();
        println("</" + OOConstants.LC_NUMBERING_LEVEL + ">");
    }
    ...
    public void writeLC_OutlineNumberingLevel_template()
    {
        ...
        for (int i = 0; i < 8; i++) // always 8
        {
            ...
            for (int j = 0; j < 8; j++)
                // always 8
                println("<" + OOConstants.OUTLUNE_NUMBERING_LEVEL + " " + OOConstants.PREFIX + "=\""
                    + OOConstants.NO_DATA + "\" " +
