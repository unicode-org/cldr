...
public class CheckExemplars extends CheckCLDR {
	...
	public static final UnicodeSet AlwaysOK = (UnicodeSet) new UnicodeSet("[[[:script=common:][:script=inherited:]-[:Default_Ignorable_Code_Point:]] [\u066A-\u066C]]").freeze(); //[\\u200c-\\u200f] [:script=common:][:script=inherited:]
