...
//            }
    ...
    static String[][] SAMPLE_PATTERNS = {
        ...
        { "ar", "two", "كتابان" },
        { "ar", "zero", "{0} كتاب" },
        { "az", "one", "Sizin alış-veriş kartınızda {0} X var. Onları almaq istəyirsiniz?" },
        { "az", "other", "Sizin alış-veriş kartınızda {0} X var. Onu almaq istəyirsiniz?" },
        { "bg", "one", "{0} ден" },
        { "bg", "other", "{0} дена" },
        ...
        { "uz", "other", "Xarid savatingizda {0} X bor. Ularni sotib olishni xohlaysizmi?" },
        { "vi", "other", "{0} ngày" },
        { "zh", "other", "{0} 天" },
        { "zh_Hant", "other", "{0} 日" },
    ...
    static String[][] ORDINAL_SAMPLES = {
        ...
        {"zu","Thatha indlela ejikela kwesokudla yoku-{0}","1"},
        {"zu","Thatha indlela ejikela kwesokudla yesi-{0}","2"},
        {"zu","Thatha indlela ejikela kwesokudla yama-{0}","10"},
