...
<!--    //ldml/characters/ellipsis[@type="final"]    -->
    <msg id='8185172660664561036' desc='Supply the elipsis pattern for when the final part of a string is omitted. Note: before translating, be sure to read http://cldr.org/translation/characters.'
     ><ph name='FIRST_PART_OF_TEXT'><ex>very long na</ex>{0}</ph>…</msg>
    <!-- English original:    {0}…    -->
     * and
<!--    //ldml/characters/exemplarCharacters[@type="currencySymbol"]    -->
    <msg id='684343635911473473' desc='Supply the characters used in your language for the "currencySymbol" category.  Note: before translating, be sure to read http://cldr.org/translation/exemplars.'
    ...
    public static void main(String[] args) {
        Map<String, String> info = load("/Users/markdavis/Documents/workspace/cldr/tools/java/org/unicode/cldr/unittest/data/xmb/", 
                "en.xml");
        System.out.println("============");
