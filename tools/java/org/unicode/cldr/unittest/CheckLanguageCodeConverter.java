...
public class CheckLanguageCodeConverter {
    public static void main(String[] args) {
        ...
        for (Entry<String, String> codeName : LanguageCodeConverter.getLanguageNameToCode().entrySet()) {
    ...
    public static void addLine(Set<LanguageLine> lines, 
        ...
        lines.add(new LanguageLine(goodCode, LanguageCodeConverter.toUnderbarLocale(goodCode), googleCode, cldrName));
        lines.add(new LanguageLine(goodCode, LanguageCodeConverter.toUnderbarLocale(badCode), googleCode, cldrName));
        lines.add(new LanguageLine(goodCode, LanguageCodeConverter.toUnderbarLocale(googleCode), googleCode, cldrName));
        lines.add(new LanguageLine(goodCode, LanguageCodeConverter.toHyphenLocale(goodCode), googleCode, cldrName));
        lines.add(new LanguageLine(goodCode, LanguageCodeConverter.toHyphenLocale(badCode), googleCode, cldrName));
