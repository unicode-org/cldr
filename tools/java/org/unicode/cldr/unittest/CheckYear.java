...
public class CheckYear {
    ...
    static class LocaleInfo {
        ...
        public void recordStock(String localeId, String stock, String dateTimePattern) {
            String skeleton = dtp.getSkeleton(dateTimePattern);
            String base = getBaseSkeleton(skeleton);
            stock2skeleton2locales.get("date-" + stock).put(skeleton.replace("yyyy", "y"), localeId);
        ...
        private void recordYearStuff(String base, String skeleton, String dateTimePattern) {
            // do the year stuff
        ...
        public String replaceFieldTypes(String dateTimePattern, String skeleton, boolean isInterval) {
            if (!isInterval) {
        ...
        private String getCorePattern(String intervalPattern) {
            // get up to the first duplicate field. Then compare the result on both sides
    ...
    public static void writeConflictingStockItems(boolean modern, String filename) throws IOException {
        ...
        for (Entry<String, Relation<String, String>> stockAndSkeleton2locales : stock2skeleton2locales.entrySet()) {
            ...
            for (Entry<String, Set<String>> entry2 : stockAndSkeleton2locales.getValue().keyValuesSet()) {
