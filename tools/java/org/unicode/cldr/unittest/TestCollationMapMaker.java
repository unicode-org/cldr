...
public class TestCollationMapMaker {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Comparator c = new com.ibm.icu.impl.MultiComparator(new Comparator[] { col,
        ...
        PrettyPrinter pretty = new PrettyPrinter().setOrdering(Collator.getInstance(ULocale.ROOT)).setSpaceComparator(
            Collator.getInstance(ULocale.ROOT).setStrength2(RuleBasedCollator.PRIMARY));
    ...
    private static void testTranslit() {
        System.out.println(javaEscape.transform("\u0001\u001F" + CldrUtility.LINE_SEPARATOR
            + "\u0061\u00A5\uFFFF\uD800\uDC00"));
    }
}