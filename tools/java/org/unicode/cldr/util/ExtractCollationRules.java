...
public class ExtractCollationRules {
    ...
    public ExtractCollationRules set(CLDRFile file) {
        ...
        for (Iterator it = file.iterator("//ldml/collations", CLDRFile.ldmlComparator); it.hasNext();) {
           ...
           // lastLen = rules.length();
            ...
            if (mainType.equals("settings")) {
                ...
                context = null;
                switch (c) {
                case 'r': appendOrdering("&", null, value, false, true); break;
                case 'p': appendOrdering("<", lastContext, value, isMultiple, true); break;
                case 's': appendOrdering("<<", lastContext, value, isMultiple, true); break;
                case 't': appendOrdering("<<<", lastContext, value, isMultiple, false); break;
                case 'i': appendOrdering("=", lastContext, value, isMultiple, false); break;
                case 'c': context = value; break;
                case 'e': appendOrdering("/", null, value, false, false); break;
                default: System.out.println("Couldn't handle: " + path + "\t" + value);
                }
                continue;
            } else {
