    ...
    static String[][] cannedRules = {
        {
            ...
            "$AfterJoiner=\\p{Grapheme_Cluster_Break=After_Joiner}",
            "3) $CR  	\u00D7  	$LF",
            "4) ( $Control | $CR | $LF ) 	\u00F7",
            "5) \u00F7 	( $Control | $CR | $LF )",
            "6) $L 	\u00D7 	( $L | $V | $LV | $LVT )",
            ...
            "28) ($AL | $ZJ | $HL) \u00D7 ($AL | $ZJ | $HL)",
            "# LB 29  Do not break between numeric punctuation and alphabetics (\"e.g.\").",
            "29) $IS \u00D7 ($AL | $ZJ | $HL)",
            "# LB 30  Do not break between letters, numbers or ordinary symbols and opening or closing punctuation.",
            "30.01) ($AL | $ZJ | $HL | $NU) \u00D7 $OP",
            "30.02) $CP \u00D7 ($AL | $ZJ | $HL | $NU)",
            "# LB 30a  Do not break between ID characters and the Zero Width Joiner.",
            "30.11) $ZJ \u00D7 $ID",
            "30.12) $ID \u00D7 $ZJ",
        },{
            "SentenceBreak",
            ...
            "$AfterJoiner=\\p{Word_Break=AfterJoiner}",
            ...
            "$Joiner=($Joiner $FE*)",
            "$AfterJoiner=($AfterJoiner $FE*)",
            //"# Do not break within CRLF",
            "3) $CR  	\u00D7  	$LF",
            "3.1) ($Newline | $CR | $LF)	\u00F7",
            "3.2) \u00F7    ($Newline | $CR | $LF)",
            "3.3) $Joiner \u00D7 $AfterJoiner",
            //"3.4) ( $Control | $CR | $LF ) 	\u00F7",
            //"3.5) \u00F7 	( $Control | $CR | $LF )",
            //"3.9) \u00D7 	$Extend",
            //"3.91) [^$Control | $CR | $LF] \u00D7 	$Extend",
