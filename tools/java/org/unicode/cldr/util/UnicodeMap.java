...
public final class UnicodeMap implements Cloneable, Freezable, Externalizable {
   ...
   */
    ...
    public UnicodeMap put(String string, Object value) {
      if (locked) throw new UnsupportedOperationException("Attempt to modify locked object");
      if (UTF16.hasMoreCodePointsThan(string,1)) {
        stringMap.put(string, value);
        staleAvailableValues = true;
        return this;
      }
      return put(UTF16.charAt(string,0), value);
    }
    ...
    public UnicodeSet getSet(Object value, UnicodeSet result) {
        ...
        if (value != null) {
          for (Object key : stringMap.keySet()) {
            Object newValue = stringMap.get(key);
    ...
    public Collection getAvailableValues(Collection result) {
      ...
      if (result == null) {
        result = new ArrayList(availableValues.size());
      }
    ...
    public abstract static class Composer {
      /**
       * If the result doesn't vary by the codepoint or string, override this routine alone. Otherwise override the first two.
       * @param a
       * @param b
       */
      public abstract Object compose(Object a, Object b);
      
      public Object compose(int codePoint, Object a, Object b) {
        return compose(a,b);
      }
      public Object compose(String string, Object a, Object b) {
        return compose(a,b);
      }
    }
    ...
    public UnicodeMap composeWith(UnicodeSet set, Object value, Composer composer) {
      for (UnicodeSetIterator it = new UnicodeSetIterator(set); it.next();) {
        ...
        if (i == it.IS_STRING) {
          String s = it.string;
          Object v1 = getValue(s);
          Object v3 = composer.compose(s, v1, value);
