...
public class VerifyZones {
    ...
    public static class ZoneFormats {
        ...
        public enum Type {generic, standard, daylight, genericOrStandard}
        ...
        public String formatGMT(TimeZone currentZone) {
            ...
            SimpleDateFormat dateFormat = icuServiceBuilder.getDateFormat("gregorian", hourFormatPlusMinus[tzOffset >= 0 ? 0 : 1]);
        ...
        public String getExemplarCity(String timezoneString) {
            String exemplarCity = cldrFile.getWinningValue("//ldml/dates/timeZoneNames/zone[@type=\""+timezoneString+"\"]/exemplarCity");
        ...
        public String getMetazoneName(String metazone, Length length, Type typeIn) {
            ...
            return name != null ? name : typeIn != Type.genericOrStandard ? "n/a" : getMetazoneName(metazone, length, Type.standard);
        }
    }
    ...
    private final static List<Format> FORMAT_LIST = Arrays.asList(Format.VVVV, Format.vvvv, Format.v, Format.zzzz, Format.z, Format.zzzz, Format.z);
    ...
    public static void main(String[] args) throws IOException {
        ...
        Matcher timezoneFilter = timezoneFilterString == null ? null : Pattern.compile(timezoneFilterString).matcher("");
...
//            .addColumn("Region/City").setSpanRows(true)
    ...
    private static void addZones(ZoneFormats englishZoneFormats, CLDRFile cldrFile, Matcher timezoneFilter, TablePrinter output) throws IOException {
        ...
        for (MetazoneRow row : rows) {
            ...
            String longGenericOrStandard = englishZoneFormats.getMetazoneName(metazone, Length.LONG, Type.genericOrStandard);
