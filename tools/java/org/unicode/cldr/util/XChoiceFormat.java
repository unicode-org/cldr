...
public class XChoiceFormat {
  ...
  public static void main(String[] args) {
    Object[] tests = { 
        new ULocale("en"), "There {N0:are no files|N1:is 1 file|N:are #,### files} in the directory.", 
        new ULocale("fr"), "There {N0:is aucun file|N1:is 1 file|N:are #,### files} in the directory.", 
        new ULocale("sl"), "There {N0:are no mest|S1:is #,### mesto|S2:are #,### mesti|S234:are #,### mesta|N:are #,### mest} in the directory.",
        new ULocale("ru"), "There {N0:are no zavody|S1:is #,### zavod|S234:are #,### zavoda|N:are #,### zavodov} in the directory.", };
