...
%>
<p>The main exemplar characters are the ones most people would recognize as being the ones "in your language". The Index characters are the ones that you would see as the index in a contact list, for example. For more information, see XXX</p>
