...
<p> Enter narrow month abbreviations for the Gregorian calendar.  Narrow month abbreviations are often used to create pocket sized calendars.  Narrow month abbreviations should be a single character and may be identical to the abbreviations for other months. If no value is entered, these will default to be the month numbers 1 through 12 for January through December, respectively.</p>
