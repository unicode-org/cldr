 ...
 * @module forum
 */
define("js/special/prevforum.js", ["js/special/SpecialPage.js", "dojo/request", "dojo/window"], 
	...
	Page.prototype.show = function show(params) {
		...
		if(surveyCurrentLocale=='') {
			...
			request
			.get('SurveyAjax?s='+surveySessionId+'&what=forum_fetch&xpath=0&_='+surveyCurrentLocale+'&cldrVersion='+surveyLastVoteVersion, {handleAs: 'json'})
			.then(function(json) {
				if(json.err) {
				...
				ourDiv.appendChild(createChunk('CLDR '+surveyLastVoteVersion,'h1'));
