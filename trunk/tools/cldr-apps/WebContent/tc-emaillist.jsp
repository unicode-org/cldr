...
Connection conn = null;
	try {
		...
		String l[][] = cs.sm.dbUtils.sqlQueryArrayArray(conn,"select email from cldr_users where exists (select * from cldr_vet where cldr_vet.submitter = cldr_users.id) and (cldr_users.userlevel < "+UserRegistry.LOCKED+") order by email");
%>
